...
public interface WriteMetricsRequestV1OrBuilder extends
   ...
   */
  java.util.List<io.holoinsight.server.gateway.grpc.Point> 
      getPointList();
  /**
   * <code>repeated .io.holoinsight.server.gateway.grpc.Point point = 2;</code>
   */
   ...
   * <code>repeated .io.holoinsight.server.gateway.grpc.Point point = 2;</code>
   */
  java.util.List<? extends io.holoinsight.server.gateway.grpc.PointOrBuilder> 
      getPointOrBuilderList();
  /**
   * <code>repeated .io.holoinsight.server.gateway.grpc.Point point = 2;</code>
   */
  io.holoinsight.server.gateway.grpc.PointOrBuilder getPointOrBuilder(
      int index);
