...
public interface SpanObjectOrBuilder extends
   ...
   */
  java.util.List<io.holoinsight.server.storage.grpc.trace.SegmentReference> getRefsList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SegmentReference refs = 5;</code>
   */
  java.util.List<? extends io.holoinsight.server.storage.grpc.trace.SegmentReferenceOrBuilder> getRefsOrBuilderList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SegmentReference refs = 5;</code>
   */
  io.holoinsight.server.storage.grpc.trace.SegmentReferenceOrBuilder getRefsOrBuilder(int index);
   ...
   */
  java.util.List<io.holoinsight.server.storage.grpc.common.KeyStringValuePair> getTagsList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.common.KeyStringValuePair tags = 12;</code>
   */
  java.util.List<? extends io.holoinsight.server.storage.grpc.common.KeyStringValuePairOrBuilder> getTagsOrBuilderList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.common.KeyStringValuePair tags = 12;</code>
   */
  io.holoinsight.server.storage.grpc.common.KeyStringValuePairOrBuilder getTagsOrBuilder(int index);
   ...
   */
  java.util.List<io.holoinsight.server.storage.grpc.trace.Log> getLogsList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.Log logs = 13;</code>
   */
  java.util.List<? extends io.holoinsight.server.storage.grpc.trace.LogOrBuilder> getLogsOrBuilderList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.Log logs = 13;</code>
   */
  io.holoinsight.server.storage.grpc.trace.LogOrBuilder getLogsOrBuilder(int index);
