...
public class GaeaCollectConfigDOExample {
    ...
    public GaeaCollectConfigDOExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andBizTenantEqualToColumn(GaeaCollectConfigDO.Column column) {
            addCriterion(new StringBuilder("biz_tenant = ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
