...
public interface QueryDataByPksRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:scheduler.QueryDataByPksRequest)
   ...
   */
  java.lang.String getPkValsJson();

  /**
   * <code>string pkValsJson = 2;</code>
   */
  com.google.protobuf.ByteString getPkValsJsonBytes();
