...
public class MarketplacePluginServiceImpl extends
                                          ServiceImpl<MarketplacePluginMapper, MarketplacePlugin>
                                          implements MarketplacePluginService {
    ...
    @Override
    public MonitorPageResult<MarketplacePluginDTO> getListByPage(MonitorPageRequest<MarketplacePluginDTO> MarketplacePluginDTORequest) {
        ...
        wrapper.select(MarketplacePlugin.class, info -> !info.getColumn().equals("creator")
