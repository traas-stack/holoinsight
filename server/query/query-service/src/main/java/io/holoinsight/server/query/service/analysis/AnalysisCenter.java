...
/**
 * @author wanpeng.xwp
 * @version : AnalysisAggregators.java, v 0.1 2022年12月08日 16:38 wanpeng.xwp Exp $
 */
public class AnalysisCenter {
    private static final Map<String, BiFunction<Map<String, String>, String, Mergable>> ANALYSIS_AGGREGATORS = new HashMap();
