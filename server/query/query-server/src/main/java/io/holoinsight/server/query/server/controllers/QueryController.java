...
public class QueryController {
    ...
    public ResponseEntity<?> queryServiceInstanceList(@RequestBody QueryProto.QueryMetaRequest request) {
        try {
    ...
    public ResponseEntity<?> queryComponentTraceIds(@RequestBody QueryProto.QueryMetaRequest request) {
        try {
