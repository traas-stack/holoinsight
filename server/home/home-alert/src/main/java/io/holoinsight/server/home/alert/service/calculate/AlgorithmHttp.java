...
public class AlgorithmHttp {
    ...
    public static String invokeAlgorithm(String algorithmUrl, String requestBody) {
        ...
        try {
            ...
            if (respose.code != 200) {
                LOGGER.error("[InvokeAlgorithmError],AlgorithmUrl={},requestBody={},response={},content={}", algorithmUrl, requestBody, respose.code, respose.getStringResponse());
                return null;
            } else {
                LOGGER.info("[InvokeAlgorithmError],AlgorithmUrl={},requestBody={},response={},content={}", algorithmUrl, requestBody, respose.code, respose.getStringResponse());
            }
        } catch (Exception e) {
