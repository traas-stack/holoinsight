...
public class SegmentEsServiceImpl extends RecordEsService<SegmentEsDO> implements SegmentEsService {
    ...
    public TraceBrief queryBasicTraces(final String tenant, String serviceName, String serviceInstanceName, String endpointName,
        ...
        if (StringUtils.isNotEmpty(serviceInstanceName)) {
            boolQueryBuilder.must(new TermQueryBuilder(SegmentEsDO.SERVICE_INSTANCE_NAME, serviceInstanceName));
        }
        ...
        if (CollectionUtils.isNotEmpty(tags)) {
            ...
            tags.forEach(tag -> tagMatchQuery.must(new TermQueryBuilder(SegmentEsDO.TAGS, tag.toString())));
        ...
        SearchRequest searchRequest = new SearchRequest(new String[] {SegmentEsDO.INDEX_NAME}, searchSourceBuilder);
