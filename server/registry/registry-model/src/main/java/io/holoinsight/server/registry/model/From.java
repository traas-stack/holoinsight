...
public class From {
    ...
    public static class ProcessPerf {
        ...
        /**
         * 如果非空则进程的cmdline必须包含该关键字 '/opt/taobao/java/bin/java -cp /home/admin/xxx/lib/* -server -XX:+UnlockExperimentalVMOptions -Xms8g -Xmx8g ..'
         */
        private Set<String> includeKeywords;
        /**
         * 如果非空则进程的cmdline必须不包含该关键字 '/opt/taobao/java/bin/java -cp /home/admin/xxx/lib/* -server -XX:+UnlockExperimentalVMOptions -Xms8g -Xmx8g ..'
         */
    ...
    public static class Log {
        ...
        public static class LogPath {
             ...
             * 推荐 path > format > glob > regexp.
             * 注意regexp和glob可能会导致多个文件.
             */
            private String type;
            /**
             * 当type==path时填写该字段为绝对路径
             * 当type==glob时填写该字段为glob表达式 /home/admin/logs/gateway/common-error*.log
             * 当type==format时填写该字段为表达式, /home/admin/logs/gateway/{time:yyyy}/{time:MM}/{time:dd}/common-error.log
