...
public class GaeaCollectConfigDO {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getBizTenant() == null ? other.getBizTenant() == null : this.getBizTenant().equals(other.getBizTenant()))
            && (this.getType() == null ? other.getType() == null : this.getType().equals(other.getType()))
            && (this.getJson() == null ? other.getJson() == null : this.getJson().equals(other.getJson()))
            && (this.getCollectRange() == null ? other.getCollectRange() == null : this.getCollectRange().equals(other.getCollectRange()))
            && (this.getExecutorSelector() == null ? other.getExecutorSelector() == null : this.getExecutorSelector().equals(other.getExecutorSelector()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getExecutorSelector() == null) ? 0 : getExecutorSelector().hashCode());
        return result;
    }
    ...
    public enum Column {
        ...
        bizTenant("biz_tenant", "bizTenant", "VARCHAR", false),
        type("type", "type", "VARCHAR", true),
        json("json", "json", "LONGVARCHAR", false),
        collectRange("collect_range", "collectRange", "LONGVARCHAR", false),
        executorSelector("executor_selector", "executorSelector", "LONGVARCHAR", false);
