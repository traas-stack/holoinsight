...
public class EndpointEsServiceImpl implements EndpointEsService {
    ...
    public List<Endpoint> getEndpointList(String tenant, String service, long startTime, long endTime) throws IOException {
        ...
        BoolQueryBuilder queryBuilder = QueryBuilders.boolQuery()
                ...
                .must(QueryBuilders.termQuery(EndpointRelationEsDO.DEST_SERVICE_NAME, service))
...
//    @Override
//    public List<BizopsEndpoint> getEntryEndpointList(String tenant, long startTime, long endTime) throws IOException {
...
//                                    .subAggregation(AggregationBuilders.filter(ServiceRelationEsDO.TRACE_STATUS, QueryBuilders.termQuery(ServiceRelationEsDO.TRACE_STATUS, "2"))
...
//
//    @Override
//    public List<BizopsEndpoint> getErrorCodeList(String tenant, String service, String endpoint, boolean isEntry, int traceIdSize, long startTime, long endTime) throws IOException {
//        List<BizopsEndpoint> result = new ArrayList<>();
//
//        TermsAggregationBuilder aggregationBuilder = AggregationBuilders
