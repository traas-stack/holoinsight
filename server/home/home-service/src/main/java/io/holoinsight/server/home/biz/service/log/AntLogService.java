...
public class AntLogService {
    ...
    //todo: 超时，容量需要调整一下
    private volatile LoadingCache<String, AntLogInfo> infoCache = CacheBuilder.newBuilder()
            .concurrencyLevel(10)
            .expireAfterAccess(20, TimeUnit.MINUTES)
            .maximumSize(1024)
            .build(new CacheLoader<String, AntLogInfo>() {
                @Override
     ...
     * @return
     */
    public ArrayList<AntLogInfo> queryLogInfo(String region, String app) throws URISyntaxException, HttpException {
        ...
        AntLogApi<ArrayList<AntLogInfo>> response = JSON.parseObject(responseStr, new TypeReference<AntLogApi<ArrayList<AntLogInfo>>>(){});
    ...
    public AntLogInfo queryLogInfo(String region, String app, String logPath) throws URISyntaxException, HttpException {
        ArrayList<AntLogInfo> infos = queryLogInfo(region, app);
        for (AntLogInfo info : infos) {
    ...
    public AntLogInfo queryCustomLogInfo(String region, String app) throws URISyntaxException, HttpException {
        return queryLogInfo(region, app, LogConstants.MINI_PROGRAM_LOG_CUSTOM_PATH);
    }

    public AntLogInfo queryStdoutLogInfo(String region, String app) throws URISyntaxException, HttpException {
        return queryLogInfo(region, app, LogConstants.MINI_PROGRAM_LOG_PATH_STDOUT);
    }

    public ArrayList<AntLogInfo> queryLogInfos(String region, String app) throws URISyntaxException, HttpException {
