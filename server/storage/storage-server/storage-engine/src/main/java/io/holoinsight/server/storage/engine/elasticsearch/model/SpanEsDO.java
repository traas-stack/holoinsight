...
public class SpanEsDO extends RecordEsDO {
    ...
    public static SpanEsDO fromSpan(Span span, Resource resource) {
        ...
        spanEsDO.setTimeBucket(TimeBucket.getTimeBucket(span.getStartTimeUnixNano() / 1000000, DownSampling.Second));
        ...
        spanEsDO.setLatency((int) ((span.getEndTimeUnixNano() - span.getStartTimeUnixNano()) / 1000000));
