...
/**
 * <p>
 * GetAgentConfigurationService class.
 * </p>
 *
 * @author sw1136562366
 */
public class GetAgentConfigurationService {
   ...
   * </p>
   */
  public AgentConfiguration getAgentConfiguration(String tenant, String service, String appId,
      String envId) throws JsonProcessingException {
  ...
  public List<AgentConfiguration> getALLFromDB() throws JsonProcessingException {
    List<AgentConfigurationDO> agentConfigurationDOList =
        agentConfigurationDOMapper.selectByExampleWithBLOBs(null);
    ...
    for (AgentConfigurationDO agentConfigurationDO : agentConfigurationDOList) {
      Map<String, String> configuration =
          new ObjectMapper().readValue(agentConfigurationDO.getValue(), HashMap.class);
      ...
      AgentConfiguration agentConfiguration = new AgentConfiguration(
          agentConfigurationDO.getTenant(), agentConfigurationDO.getService(),
          agentConfigurationDO.getAppId(), agentConfigurationDO.getEnvId(), configuration,
  ...
  private AgentConfiguration getOneFromDB(String tenant, String service, String appId, String envId)
      throws JsonProcessingException {
    AgentConfigurationDOExample example =
        AgentConfigurationDOExample.newAndCreateCriteria().andTenantEqualTo(tenant) //
            .andServiceEqualTo(service) //
            .andAppIdEqualTo(appId) //
            .andEnvIdEqualTo(envId) //
            .example(); //

    AgentConfigurationDO agentConfigurationDO =
        agentConfigurationDOMapper.selectOneByExampleWithBLOBs(example);
    if (agentConfigurationDO != null) {
      Map<String, String> configuration =
          JsonUtils.fromJson(agentConfigurationDO.getValue(), HashMap.class);
