...
//                ParaCheckUtil.checkParaNotBlank(integrationPluginDTO.json, "json");
                ...
                IntegrationPluginDTO item = integrationPluginService.queryById(integrationPluginDTO.getId(), RequestContext.getContext().ms.getTenant());
...
//                integrationPluginDTO.setTenant(MonitorCookieUtil.getTenantOrException());
                IntegrationPluginDTO update = integrationPluginService.updateByRequest(integrationPluginDTO);

                assert mu != null;
                userOpLogService.append("integration_plugin", String.valueOf(update.getId()),
                        OpType.UPDATE, mu.getLoginName(), ms.getTenant(), J.toJson(integrationPluginDTO),
    ...
    public JsonResult<Object> deleteById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                IntegrationPluginDTO byId = integrationPluginService.queryById(id, RequestContext.getContext().ms.getTenant());
                if(byId == null){
                ...
                userOpLogService.append("integration_plugin", String.valueOf(byId.getId()),
    ...
    public JsonResult<Object> deleteByType(@PathVariable("type") String type) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                List<Long> ids = byTypes.stream().map(IntegrationPluginDTO::getId).collect(Collectors.toList());
                for (long id : ids) {
                    integrationPluginService.deleteById(id);
                }
                JsonResult.createSuccessResult(result, null);
                for (long id : ids) {
                    userOpLogService.append("integration_plugin", String.valueOf(id),
                            OpType.DELETE, RequestContext.getContext().mu.getLoginName(),
    ...
    @ResponseBody
    @MonitorScopeAuth(targetType = AuthTargetType.TENANT, needPower = PowerConstants.EDIT)
    public JsonResult<IntegrationPluginDTO> save(@RequestBody IntegrationPluginDTO integrationPluginDTO) {
        final JsonResult<IntegrationPluginDTO> result = new JsonResult<>();
        facadeTemplate.manage(result, new ManageCallback() {
            @Override
            public void checkParameter() {
//                ParaCheckUtil.checkParaNotBlank(integrationPluginDTO.name, "name");
            ...
            public void doManage() {
                ...
                assert mu != null;
                userOpLogService.append("integration_plugin", String.valueOf(save.getId()),
                        OpType.CREATE, mu.getLoginName(), ms.getTenant(), J.toJson(integrationPluginDTO),
    ...
    public JsonResult<IntegrationPluginDTO> queryById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                IntegrationPluginDTO integrationPluginDTO = integrationPluginService.queryById(id, RequestContext.getContext().ms.getTenant());
    ...
    public JsonResult<List<IntegrationPluginDTO>> queryByName(@PathVariable("name") String name) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                List<IntegrationPluginDTO> integrationPluginDTOs = integrationPluginService.findByMap(params);
    ...
    public JsonResult<List<IntegrationPluginDTO>> listAll() {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                List<IntegrationPluginDTO> integrationPluginDTOs = integrationPluginService.findByMap(Collections.singletonMap("tenant", MonitorCookieUtil.getTenantOrException()));
    ...
    public JsonResult<List<String>> listAllNames() {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                List<IntegrationPluginDTO> integrationPluginDTOs = integrationPluginService.findByMap(Collections.singletonMap("tenant", MonitorCookieUtil.getTenantOrException()));
                List<String> names = integrationPluginDTOs == null ? null : integrationPluginDTOs.stream().map(
                        IntegrationPluginDTO::getName).collect(
                        Collectors.toList());
