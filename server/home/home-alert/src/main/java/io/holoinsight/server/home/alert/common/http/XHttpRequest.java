...
public class XHttpRequest implements Serializable {
    ...
    public static XHttpRequest get(String url, Map<String, Object> params, Map<String, String> inHeaders,
                                   String charset, int timeoutMillisecond) {
    ...
    public static XHttpRequest post(String url, Map<String, String> inHeaders, String charset, int timeoutMillisecond,
                                    byte[] postString) {
        return post(url, inHeaders, charset, timeoutMillisecond, postString, null);
    }

    public static XHttpRequest post(String url, Map<String, String> inHeaders, String charset, int timeoutMillisecond,
                                    byte[] postString, String contentType) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "POST";
        ret.url = url;
        ret.inHeaders = inHeaders;
    ...
    public static XHttpRequest put(String url, Map<String, String> inHeaders, String charset, String raw,
                                   String contentType, int timeoutMillisecond) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "put";
        ret.url = url;
        ret.inHeaders = inHeaders;
    ...
    public static XHttpRequest delete(String url, Map<String, String> inHeaders, String charset, int timeoutMillisecond) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "delete";
        ret.url = url;
        ret.inHeaders = inHeaders;
    ...
    public static XHttpRequest putJson(String url, Map<String, String> inHeaders, String charset, String raw,
    ...
    public static XHttpRequest putFile(String url, String file, Map<String, String> inHeaders, int timeoutMillisecond) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "put";
        ret.url = url;
        ret.inHeaders = inHeaders;
    ...
    public static XHttpRequest postJson(String url, Map<String, String> inHeaders, String charset, String raw,
                                        int timeoutMillisecond) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "post";
        ret.url = url;
    ...
    public static XHttpRequest post(String url, Map<String, String> inHeaders, String charset, int timeoutMillisecond,
                                    Map<String, String> postForm, String contentType) {
        XHttpRequest ret = new XHttpRequest();
        ret.method = "POST";
        ret.url = url;
        ret.inHeaders = inHeaders;
    ...
    public String toString() {
        ...
        stringBuilder.append("XHttpRequest [url:").append(url).append(";params:").append(mapToString(params))
            .append(";charset=").append(charset).append(", method=").append(method).append(", inHeaders=")
            .append(mapToString(inHeaders)).append(", postString=").append(postBody).append(", postForm=")
            .append(mapToString(postForm)).append(", contentType=").append(contentType).append(", timeoutMillisecond=")
            .append(timeoutMillisecond).append("]");
