...
public class CollectTargetMaintainer {
    ...
    public void postConstruct() {
        MetricsUtils.SM.gauge(StringsKey.of("target.count"), collectTargetStorage, CollectTargetStorage::size);
            ...
            if (oldT == null) {
                ...
                switch (result) {
                    case UPDATE_INDEX:
                        ...
                        LOGGER.info("mt u [{}/{}] dim={}", oldT.getTemplateId(), key.getDimId(), target.getInner());
                        break;
