...
public class CustomPluginFacadeImpl extends BaseFacade {
    ...
    public JsonResult<CustomPluginDTO> update(@RequestBody CustomPluginDTO customPluginDTO) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void checkParameter() {
                ...
                CustomPluginDTO item = customPluginService.queryById(customPluginDTO.getId(), RequestContext.getContext().ms.getTenant());
            ...
            public void doManage() {
                ...
                assert mu != null;
                userOpLogService.append("custom_plugin", String.valueOf(update.getId()),
                    OpType.UPDATE, mu.getLoginName(), ms.getTenant(), J.toJson(customPluginDTO),
                    J.toJson(update), null, "custom_plugin_update");
    ...
    public JsonResult<CustomPluginDTO> save(@RequestBody CustomPluginDTO customPluginDTO) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                assert mu != null;
                userOpLogService.append("custom_plugin", String.valueOf(save.getId()),
                    OpType.CREATE, mu.getLoginName(), ms.getTenant(), J.toJson(customPluginDTO),
                    null, null, "custom_plugin_create");
    ...
    public JsonResult<Boolean> updateParentFolderId(@RequestBody CustomPluginDTO customPluginDTO) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                CustomPluginDTO update = customPluginService.queryById(customPluginDTO.id, RequestContext.getContext().ms.getTenant());
                if(null == update){
                ...
                assert mu != null;
                userOpLogService.append("custom_plugin", String.valueOf(update.getId()),
                        OpType.UPDATE, mu.getLoginName(), ms.getTenant(), J.toJson(custom),
                        J.toJson(update), null, "custom_plugin_update");
    ...
    public JsonResult<CustomPluginDTO> queryById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                CustomPluginDTO customPluginDTO = customPluginService.queryById(id, RequestContext.getContext().ms.getTenant());
    ...
    public JsonResult<Object> deleteById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                CustomPluginDTO byId = customPluginService.queryById(id, RequestContext.getContext().ms.getTenant());
                if(null == byId){
                    throw new MonitorException(ResultCodeEnum.CANNOT_FIND_RECORD, "can not find record");
                }
                customPluginService.deleteById(id);
                JsonResult.createSuccessResult(result, null);
                userOpLogService.append("custom_plugin", String.valueOf(byId.getId()),
    ...
    @MonitorScopeAuth(targetType = AuthTargetType.TENANT, needPower = PowerConstants.VIEW)
    public JsonResult<List<CustomPluginDTO>> queryByParentFolderIdAndTenant(@PathVariable("parentFolderId") Long parentFolderId) {
    ...
    @MonitorScopeAuth(targetType = AuthTargetType.TENANT, needPower = PowerConstants.VIEW)
    public JsonResult<List<CustomPluginDTO>> queryByNameLikeAndTenant(@PathVariable("name") String name) {
        final JsonResult<List<CustomPluginDTO>> result = new JsonResult<>();
        facadeTemplate.manage(result, new ManageCallback() {
            @Override
            public void checkParameter() {
    ...
    @MonitorScopeAuth(targetType = AuthTargetType.TENANT, needPower = PowerConstants.VIEW)
    public JsonResult<List<CustomPluginDTO>> queryByCreatorAndTenant(@PathVariable("creator") String creator) {
        final JsonResult<List<CustomPluginDTO>> result = new JsonResult<>();
        facadeTemplate.manage(result, new ManageCallback() {
            @Override
            public void checkParameter() {
    ...
    @ResponseBody
    @MonitorScopeAuth(targetType = AuthTargetType.TENANT, needPower = PowerConstants.VIEW)
    public JsonResult<MonitorPageResult<CustomPluginDTO>> pageQuery(@RequestBody MonitorPageRequest<CustomPluginDTO> customPluginRequest) {
