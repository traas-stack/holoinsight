...
/**
 * <p>created at 2020-08-19
 *
 * @author xzchaoo
 */
public final class GrpcUtils {
    // public static final Metadata.Key<String>  INTERNAL       = Metadata.Key.of("INTERNAL", Metadata.ASCII_STRING_MARSHALLER);
    //
     ...
     * <p>rebind.</p>
     */
    public static ServerServiceDefinition rebind(ServerServiceDefinition ssd, String oldPrefix, String newPrefix) {
        ...
        for (ServerMethodDefinition<?, ?> smd : ssd.getMethods()) {
            ...
            MethodDescriptor<?, ?> newMd = md.toBuilder().setFullMethodName(replaceName(md.getFullMethodName(), oldPrefix, newPrefix)).build();
