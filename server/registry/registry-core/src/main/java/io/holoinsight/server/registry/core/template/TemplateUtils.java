...
public class TemplateUtils {
    public static CollectTemplate build(GaeaCollectConfigDO gcc) {
        ...
        if (gcc.getCollectRange() != null && !"null".equals(gcc.getCollectRange()) && !"{}".equals(gcc.getCollectRange())) {
        ...
        if (StringUtils.isEmpty(t.getCollectRange().getType()) && ExecutorSelector.CENTRAL.equals(t.getExecutorSelector().getType())) {
