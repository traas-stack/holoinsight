...
public final class AlarmNotifyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse> getSendAlarmNotifyMethod;

  @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SendAlarmNotify",
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse> getSendAlarmNotifyMethod() {
          ...
          AlarmNotifyServiceGrpc.getSendAlarmNotifyMethod = getSendAlarmNotifyMethod =
              io.grpc.MethodDescriptor.<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>newBuilder()
                  ...
                  .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                      .marshaller(io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest
                          .getDefaultInstance()))
                  .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                      .marshaller(io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse
                          .getDefaultInstance()))
                  .setSchemaDescriptor(
                      new AlarmNotifyServiceMethodDescriptorSupplier("SendAlarmNotify"))
                  .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse> getSendAlarmNotifyV2Method;

  @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SendAlarmNotifyV2",
      requestType = io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2.class,
      responseType = io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse> getSendAlarmNotifyV2Method() {
    ...
    if ((getSendAlarmNotifyV2Method = AlarmNotifyServiceGrpc.getSendAlarmNotifyV2Method) == null) {
      synchronized (AlarmNotifyServiceGrpc.class) {
        if ((getSendAlarmNotifyV2Method =
            AlarmNotifyServiceGrpc.getSendAlarmNotifyV2Method) == null) {
          AlarmNotifyServiceGrpc.getSendAlarmNotifyV2Method = getSendAlarmNotifyV2Method =
              io.grpc.MethodDescriptor.<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>newBuilder()
                  ...
                  .setSampledToLocalTracing(true)
                  .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                      .marshaller(io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2
                          .getDefaultInstance()))
                  .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                      .marshaller(io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse
                          .getDefaultInstance()))
                  .setSchemaDescriptor(
                      new AlarmNotifyServiceMethodDescriptorSupplier("SendAlarmNotifyV2"))
                  .build();
        }
      }
    }
  ...
  public static AlarmNotifyServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceStub>() {
          @Override
          public AlarmNotifyServiceStub newStub(io.grpc.Channel channel,
   ...
   */
  public static AlarmNotifyServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceBlockingStub>() {
          @Override
          public AlarmNotifyServiceBlockingStub newStub(io.grpc.Channel channel,
              io.grpc.CallOptions callOptions) {
   ...
   */
  public static AlarmNotifyServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AlarmNotifyServiceFutureStub>() {
          @Override
          public AlarmNotifyServiceFutureStub newStub(io.grpc.Channel channel,
              io.grpc.CallOptions callOptions) {
  ...
  public static abstract class AlarmNotifyServiceImplBase implements io.grpc.BindableService {
    ...
    public void sendAlarmNotify(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendAlarmNotifyMethod(),
          responseObserver);
    }

    /**
     */
    public void sendAlarmNotifyV2(
        io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2 request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendAlarmNotifyV2Method(),
          responseObserver);
    }
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(getSendAlarmNotifyMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>(
                  this, METHODID_SEND_ALARM_NOTIFY)))
          .addMethod(getSendAlarmNotifyV2Method(), io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2, io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>(
  ...
  /**
   */
  public static final class AlarmNotifyServiceStub
      extends io.grpc.stub.AbstractAsyncStub<AlarmNotifyServiceStub> {
    private AlarmNotifyServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @Override
    protected AlarmNotifyServiceStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new AlarmNotifyServiceStub(channel, callOptions);
    }
  ...
  /**
   */
  public static final class AlarmNotifyServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<AlarmNotifyServiceBlockingStub> {
    private AlarmNotifyServiceBlockingStub(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @Override
    protected AlarmNotifyServiceBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new AlarmNotifyServiceBlockingStub(channel, callOptions);
    }
    ...
    /**
     */
    public io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse sendAlarmNotify(
        io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(getChannel(), getSendAlarmNotifyMethod(),
          getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse sendAlarmNotifyV2(
        io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2 request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(getChannel(), getSendAlarmNotifyV2Method(),
          getCallOptions(), request);
    }
  }
  ...
  /**
   */
  public static final class AlarmNotifyServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<AlarmNotifyServiceFutureStub> {
    private AlarmNotifyServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @Override
    protected AlarmNotifyServiceFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new AlarmNotifyServiceFutureStub(channel, callOptions);
    }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_ALARM_NOTIFY:
          serviceImpl.sendAlarmNotify(
              (io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>) responseObserver);
          break;
        case METHODID_SEND_ALARM_NOTIFY_V2:
          serviceImpl.sendAlarmNotifyV2(
              (io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyRequestV2) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.home.proto.alarm.Notify.AlarmNotifyResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (AlarmNotifyServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSendAlarmNotifyMethod()).addMethod(getSendAlarmNotifyV2Method())
              .build();
        }
      }
    }
