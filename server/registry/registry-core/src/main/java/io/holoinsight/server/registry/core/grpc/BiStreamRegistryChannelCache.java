...
class BiStreamRegistryChannelCache {
    ...
    void start() {
        scheduledFuture = commonThreadPools.getScheduler().scheduleWithFixedDelay(this::removeExpiredChannels, 1, 1, TimeUnit.MINUTES);
    }
    ...
    private static class CacheItem {
        ...
        CacheItem(ManagedChannel channel) {this.channel = channel;}
