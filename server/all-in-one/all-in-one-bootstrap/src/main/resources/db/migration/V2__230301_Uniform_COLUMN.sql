...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_block","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_block","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_block","start_time","timestamp NULL DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_block","end_time","timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ",1);
  ...
  CALL Uniform_Holoinsight_Column("alarm_block","reason","varchar(256) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_block","extra","longtext ",1);
  CALL Uniform_Holoinsight_Column("alarm_block","tenant","varchar(100) DEFAULT NULL ",1);
  CALL Uniform_Holoinsight_Column("alarm_block","hour","tinyint DEFAULT '0' COMMENT 'Shield hour'",1);
  CALL Uniform_Holoinsight_Column("alarm_block","minute","tinyint DEFAULT '0' COMMENT 'Shield minute'",1);
  CALL Uniform_Holoinsight_Column("alarm_block","source_type","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_block","source_id","bigint DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","group_name","varchar(64) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","robot_url","varchar(128) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","extra","longtext",1);
  CALL Uniform_Holoinsight_Column("alarm_ding_ding_robot","tenant","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_group","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_group","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_group","group_name","varchar(256) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_group","group_info","mediumtext",1);
  CALL Uniform_Holoinsight_Column("alarm_group","tenant","varchar(100) DEFAULT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("alarm_group","env_type","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_history","alarm_time","timestamp NULL DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","recover_time","timestamp NULL DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","duration","bigint DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","unique_id","varchar(64) NOT NULL DEFAULT '-1' COMMENT 'Alarm id'",1);
  CALL Uniform_Holoinsight_Column("alarm_history","rule_name","varchar(256) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","alarm_level","varchar(32) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","trigger_content","varchar(256) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","extra","longtext",1);
  CALL Uniform_Holoinsight_Column("alarm_history","tenant","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","source_type","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history","source_id","bigint DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_history_detail","alarm_time","timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP",1);
  ...
  CALL Uniform_Holoinsight_Column("alarm_history_detail","datasource","mediumtext",1);
  CALL Uniform_Holoinsight_Column("alarm_history_detail","extra","longtext",1);
  CALL Uniform_Holoinsight_Column("alarm_history_detail","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history_detail","source_type","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_history_detail","source_id","bigint DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_rule","rule_name","varchar(256) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","rule_type","varchar(32) NOT NULL COMMENT 'AI or RULE'",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","alarm_level","varchar(32) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","rule_describe","varchar(256) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","rule","mediumtext NOT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("alarm_rule","is_merge","tinyint NOT NULL DEFAULT '1'",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","merge_type","varchar(64) DEFAULT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("alarm_rule","notice_type","varchar(32) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","extra","longtext",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","tenant","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","alarm_content","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","source_type","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_rule","source_id","bigint DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_subscribe","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","subscriber","varchar(128) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","group_id","bigint NOT NULL DEFAULT '-1'",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","unique_id","varchar(64) NOT NULL DEFAULT '-1'",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","notice_type","varchar(256) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","status","tinyint NOT NULL DEFAULT '1'",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","tenant","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","source_type","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","source_id","bigint DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_subscribe","env_type","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alarm_webhook","creator","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","modifier","varchar(64) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","webhook_name","varchar(256) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","status","tinyint NOT NULL DEFAULT '1' COMMENT 'Callback state'",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","request_type","varchar(16) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","request_url","varchar(256) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","request_headers","mediumtext",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","request_body","mediumtext",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","type","tinyint NOT NULL DEFAULT '2' COMMENT 'Callback type'",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","extra","longtext",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","role","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alarm_webhook","tenant","varchar(100) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("alertmanager_webhook","name","varchar(255) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alertmanager_webhook","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("alertmanager_webhook","creator","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("alertmanager_webhook","modifier","varchar(45) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("apikey","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","apikey","varchar(255) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","creator","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","modifier","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","role","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","status","tinyint DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("apikey","access_config","mediumtext",1);
  CALL Uniform_Holoinsight_Column("apikey","desc","varchar(200) DEFAULT NULL",1);

-- ----------------------------
-- Table structure for cluster
-- ----------------------------
  CALL Uniform_Holoinsight_Column("cluster","id","bigint NOT NULL AUTO_INCREMENT COMMENT 'Data id'",1);
  CALL Uniform_Holoinsight_Column("cluster","ip","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster","hostname","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster","role","varchar(45) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("cluster_task","task_id","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster_task","period","bigint NOT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster_task","status","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster_task","cluster_ip","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("cluster_task","context","longtext",1);
  CALL Uniform_Holoinsight_Column("cluster_task","result","varchar(50) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("custom_plugin","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","parent_folder_id","bigint NOT NULL DEFAULT '-1'",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","plugin_type","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","status","varchar(30) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","period_type","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","conf","longtext NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","sample_log","longtext",1);
  ...
  CALL Uniform_Holoinsight_Column("custom_plugin","creator","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("custom_plugin","modifier","varchar(45) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("dashboard","title","varchar(255) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("dashboard","conf","text NOT NULL",1);
  CALL Uniform_Holoinsight_Column("dashboard","creator","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("dashboard","modifier","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("dashboard","tenant","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("dashboard","type","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("folder","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("folder","parent_folder_id","bigint DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("folder","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("folder","creator","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("folder","modifier","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_agent","tenant","varchar(100) NOT NULL COMMENT 'Tenant'",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_cluster_config","tenant","varchar(100) NOT NULL COMMENT 'Registry cluster tenant'",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_collect_config","tenant","varchar(100) NOT NULL COMMENT 'Tenant'",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_config","tenant","varchar(100) NOT NULL COMMENT 'Tenant for isolating data. Has no relation to tenants on the product tier.'",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_lock","tenant","varchar(100) NOT NULL COMMENT 'Lock tenant. Its meaning depends on the implementation of the application layer.'",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("gaea_master","tenant","varchar(100) NOT NULL COMMENT 'Master tenant. Its meaning depends on the implementation of the application layer.'",1);
...
-- ----------------------------
  CALL Uniform_Holoinsight_Column("hibernate_sequence","next_val","bigint DEFAULT NUL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("integration_plugin","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","product","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","type","varchar(200) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","status","tinyint NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","json","longtext NOT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("integration_plugin","creator","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","modifier","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","collect_range","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","template","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_plugin","version","varchar(45) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("integration_product","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_product","profile","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_product","overview","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_product","configuration","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_product","metrics","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_product","status","tinyint DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_product","type","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_product","form","longtext",1);
  CALL Uniform_Holoinsight_Column("integration_product","template","longtext",1);
  ...
  CALL Uniform_Holoinsight_Column("integration_product","creator","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_product","modifier","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("integration_product","version","varchar(45) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("meta_data","_status","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("meta_data","_basic","mediumtext",1);
  CALL Uniform_Holoinsight_Column("meta_data","_labels","longtext",1);
  CALL Uniform_Holoinsight_Column("meta_data","_annotations","longtext",1);
  CALL Uniform_Holoinsight_Column("meta_data","_modified","timestamp DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("meta_data","_modifier","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("meta_table","tenant","varchar(100) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","type","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","dict_key","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","dict_value","mediumtext NOT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","dict_value_type","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","dict_desc","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","version","int NOT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","creator","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("metadata_dictvalue","modifier","varchar(45) NOT NULL",1);
...
-- ----------------------------
  CALL Uniform_Holoinsight_Column("metric_info","id","bigint NOT NULL AUTO_INCREMENT COMMENT 'Data id'",1);
  CALL Uniform_Holoinsight_Column("metric_info","gmt_create","timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data creation time'",1);
  CALL Uniform_Holoinsight_Column("metric_info","gmt_modified","timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data modification time'",1);
  CALL Uniform_Holoinsight_Column("metric_info","metric_type","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metric_info","metrics","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metric_info","name","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metric_info","ref_id","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metric_info","tags","varchar(255) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("metric_info","tenant","varchar(100) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("openmetrics_scraper","name","varchar(255) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("openmetrics_scraper","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("openmetrics_scraper","conf","text",1);
  CALL Uniform_Holoinsight_Column("openmetrics_scraper","creator","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("openmetrics_scraper","modifier","varchar(45) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("position_biz_rule","app_id","varchar(16) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("position_biz_rule","env_id","varchar(16) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("position_biz_rule","app_name","varchar(64) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("position_biz_rule","interface_type","varchar(16) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("position_biz_rule","interface_name","varchar(256) NOT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("position_biz_rule","error_code_config","varchar(8192) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("tenant","name","varchar(255) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("tenant","code","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("tenant","desc","varchar(500) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("tenant","json","text COMMENT 'Tenant information'",1);
  CALL Uniform_Holoinsight_Column("tenant","md5","varchar(45) NOT NULL",1);
  ...
  CALL Uniform_Holoinsight_Column("tenant","product","varchar(255) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("tenant_ops","tenant","varchar(100) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("user_favorite","user_login_name","varchar(45) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("user_favorite","relate_id","varchar(300) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("user_favorite","type","varchar(50) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("user_favorite","name","varchar(200) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("user_favorite","url","varchar(1000) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("user_favorite","tenant","varchar(100) NOT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("user_oplog","table_name","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","table_entity_id","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","op_type","varchar(45) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","op_before_context","longtext",1);
  CALL Uniform_Holoinsight_Column("user_oplog","op_after_context","longtext",1);
  CALL Uniform_Holoinsight_Column("user_oplog","name","varchar(200) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","relate","varchar(1000) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","tenant","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("user_oplog","creator","varchar(45) DEFAULT NULL",1);
...
-- ----------------------------
  ...
  CALL Uniform_Holoinsight_Column("workspace","tenant","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("workspace","name","varchar(100) NOT NULL",1);
  CALL Uniform_Holoinsight_Column("workspace","desc","varchar(100) DEFAULT NULL",1);
  CALL Uniform_Holoinsight_Column("workspace","config","mediumtext DEFAULT NULL",1);
