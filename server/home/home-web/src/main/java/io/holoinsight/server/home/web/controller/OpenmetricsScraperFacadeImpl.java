...
public class OpenmetricsScraperFacadeImpl extends BaseFacade {
    ...
    public JsonResult<MonitorPageResult<OpenmetricsScraperDTO>> pageQuery(@RequestBody MonitorPageRequest<OpenmetricsScraperDTO> request) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                JsonResult.createSuccessResult(result,
                    openmetricsScraperService.getListByPage(request));
            }
        });
    ...
    //@GetMapping
    //public JsonResult<Object> index(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
    ...
    public JsonResult<Object> create(@RequestBody OpenmetricsScraperDTO openmetricsScraperDTO) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            @Override
            public void checkParameter() {
                ParaCheckUtil.checkParaNotNull(openmetricsScraperDTO.getCollectRanges(),
                    "collectRanges");
                ParaCheckUtil.checkParaNotNull(openmetricsScraperDTO.getPort(), "port");
                ParaCheckUtil.checkParaNotNull(openmetricsScraperDTO.getScrapeInterval(),
                    "interval");
                ParaCheckUtil.checkParaNotNull(openmetricsScraperDTO.getScrapeTimeout(), "timeout");
                ParaCheckUtil.checkParaNotNull(openmetricsScraperDTO.getMetricsPath(),
                    "metricPath");
            }
            ...
            public void doManage() {
                ...
                userOpLogService.append("openmetrics_scraper", String.valueOf(openmetricsScraperDTO.getId()),
    ...
    public JsonResult<Object> update(@PathVariable("id") Long id,
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                OpenmetricsScraperDTO item = openmetricsScraperService.queryById(id, RequestContext.getContext().ms.getTenant());
    ...
    public JsonResult<Object> delete(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                OpenmetricsScraperDTO model = openmetricsScraperService.queryById(id, RequestContext.getContext().ms.getTenant());
                if (model == null || !model.getTenant().equals(ms.getTenant())) {
                ...
                userOpLogService.append("openmetrics_scraper", String.valueOf(id),
