...
public class MongoDbHelper {
    ...
    public <T> T modifyById(String id, Map<String, Object> data, Class<T> tClass, String collectionName) {
    ...
    public <T> T findAndModifyInstance(Query query, Update update, Class<T> tClass, String collectionName) {
        return mongoTemplate.findAndModify(query, update, new FindAndModifyOptions().returnNew(true), tClass, collectionName);
    }
}