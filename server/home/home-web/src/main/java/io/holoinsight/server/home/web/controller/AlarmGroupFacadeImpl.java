...
public class AlarmGroupFacadeImpl extends BaseFacade {
    ...
    public JsonResult<MonitorPageResult<AlarmGroupDTO>> pageQuery(@RequestBody MonitorPageRequest<AlarmGroupDTO> pageRequest) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                JsonResult.createSuccessResult(result,
                    alarmGroupService.getListByPage(pageRequest));
            }
        });
    ...
    public JsonResult<Boolean> update(@RequestBody AlarmGroupDTO alarmGroup) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                userOpLogService.append("alarm_group", String.valueOf(alarmGroup.getId()),
                        OpType.UPDATE, RequestContext.getContext().mu.getLoginName(),
                        RequestContext.getContext().ms.getTenant(), J.toJson(item),
                        J.toJson(alarmGroup), null, "alarm_group_update");
    ...
    public JsonResult<Boolean> deleteById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                boolean rtn = false;
                AlarmGroupDTO alarmGroup = alarmGroupService.queryById(id,
                    RequestContext.getContext().ms.getTenant());
                if (alarmGroup != null) {
