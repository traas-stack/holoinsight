...
@Service
public class AlertmanagerWebhookServiceImpl extends ServiceImpl<AlertmanagerWebhookMapper, AlertmanagerWebhook> implements AlertmanagerWebhookService {
    @Override
    public MonitorPageResult<AlertmanagerWebhook> getListByPage(MonitorPageRequest<AlertmanagerWebhook> request) {
        ...
        wrapper.select(AlertmanagerWebhook.class, info -> !info.getColumn().equals("creator")
