...
public class EventTimerProxyImpl implements EventTimer {
  ...
  private EventTimer[] eventTimers = new EventTimer[TimedEvent.SUPPORTED_TIME_UNITS.length];
  ...
  @Override
  public void attach(final TimedEvent event, long timerMills,
      final TimedEventCallback timedEventCallback) {
    int timerIndex = TimedEvent.decideTimerIndex(timerMills);
