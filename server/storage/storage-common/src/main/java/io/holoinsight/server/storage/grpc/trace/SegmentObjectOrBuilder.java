...
public interface SegmentObjectOrBuilder extends
   ...
   */
  java.util.List<io.holoinsight.server.storage.grpc.trace.SpanObject> 
      getSpansList();
  /**
   * <pre>
   * Span collections included in this segment.
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SpanObject spans = 3;</code>
   */
  java.util.List<? extends io.holoinsight.server.storage.grpc.trace.SpanObjectOrBuilder> 
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SpanObject spans = 3;</code>
   */
  io.holoinsight.server.storage.grpc.trace.SpanObjectOrBuilder getSpansOrBuilder(
      int index);
