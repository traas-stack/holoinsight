...
/**
 * @author xiangwanpeng
 * @version 1.0: IntegrationProductServiceImpl.java, v 0.1 2022年06月08日 7:32 下午 wanpeng.xwp Exp $
 */
@Service
public class IntegrationProductServiceImpl extends ServiceImpl<IntegrationProductMapper, IntegrationProduct>
        implements IntegrationProductService {
    ...
    @Override
    public MonitorPageResult<IntegrationProductDTO> getListByPage(MonitorPageRequest<IntegrationProductDTO> IntegrationProductDTORequest) {
        ...
        wrapper.select(IntegrationProduct.class, info -> !info.getColumn().equals("creator")
