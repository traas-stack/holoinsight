...
public class AgentConfiguration {
     ...
     */
    public AgentConfiguration(final String tenant, final String service, final String appId, final String envId,
                              final Map<String, String> configuration, final String uuid) {
        this.tenant = tenant;
