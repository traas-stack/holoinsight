...
public class MetaDictKey {
  ...
  public static final String MNP_SLS_ACCESS_ID = "mnp_sls_id";
  public static final String MNP_SLS_ACCESS_KEY = "mnp_sls_key";
  public static final String MNP_SLS_ENDPOINT = "mnp_sls_endpoint";
