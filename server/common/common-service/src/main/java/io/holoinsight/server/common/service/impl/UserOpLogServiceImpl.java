...
import io.holoinsight.server.common.dao.mapper.UserOpLogMapper;
...
public class UserOpLogServiceImpl extends ServiceImpl<UserOpLogMapper, UserOpLog>
  ...
  public MonitorPageResult<UserOpLog> getListByPage(
    ...
    if (StringUtils.isNotBlank(userOpLog.getCreator())) {
    ...
    if (StringUtils.isNotBlank(userOpLog.getName())) {
