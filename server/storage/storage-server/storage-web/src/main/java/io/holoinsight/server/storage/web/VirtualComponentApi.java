...
public interface VirtualComponentApi {
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(code = 200, message = "请求正常。", response = VirtualComponent.class),
    ...
    @ApiOperation(
            value = "query cache list",
            nickname = "queryCacheList",
            notes = "查询缓存列表",
            response = Service.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
    ...
    @ApiOperation(
            value = "query trace list",
            nickname = "queryTraceList",
            notes = "查询调用链列表",
            response = List.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
