...
public class DictData implements Serializable {
    ...
    public DictData(int priority, String domain, String subDomain, String dictKey, String dictKeyDesc, String dictValue) {
    ...
    public DictData(String domain, String subDomain, String dictKey, String dictKeyDesc, String dictValue) {
        this.domain = domain;
        this.subDomain = subDomain;
        this.dictKey = dictKey;
        this.dictKeyDesc = dictKeyDesc;
