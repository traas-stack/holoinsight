...
public final class RegistryServiceForInternalGrpc {
  ...
  public static final String SERVICE_NAME = "io.holoinsight.server.registry.grpc.internal.RegistryServiceForInternal";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.common.grpc.GenericDataBatch,
      com.google.protobuf.Empty> getSendEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send_events",
      requestType = io.holoinsight.server.common.grpc.GenericDataBatch.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.common.grpc.GenericDataBatch,
      com.google.protobuf.Empty> getSendEventsMethod() {
      ...
      synchronized (RegistryServiceForInternalGrpc.class) {
        if ((getSendEventsMethod = RegistryServiceForInternalGrpc.getSendEventsMethod) == null) {
          RegistryServiceForInternalGrpc.getSendEventsMethod = getSendEventsMethod =
              ...
              .setSchemaDescriptor(new RegistryServiceForInternalMethodDescriptorSupplier("send_events"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest,
      io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse> getBistreamProxyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "bistream_proxy",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest,
      io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse> getBistreamProxyMethod() {
      ...
      synchronized (RegistryServiceForInternalGrpc.class) {
        if ((getBistreamProxyMethod = RegistryServiceForInternalGrpc.getBistreamProxyMethod) == null) {
          RegistryServiceForInternalGrpc.getBistreamProxyMethod = getBistreamProxyMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse.getDefaultInstance()))
              .setSchemaDescriptor(new RegistryServiceForInternalMethodDescriptorSupplier("bistream_proxy"))
              .build();
        }
      }
    }
   ...
   */
  public static RegistryServiceForInternalBlockingStub newBlockingStub(
   ...
   */
  public static RegistryServiceForInternalFutureStub newFutureStub(
      io.grpc.Channel channel) {
   ...
   * </pre>
   */
  public static abstract class RegistryServiceForInternalImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void bistreamProxy(io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.common.grpc.GenericDataBatch,
                com.google.protobuf.Empty>(
                  this, METHODID_SEND_EVENTS)))
          .addMethod(
            getBistreamProxyMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest,
                io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse>(
   ...
   * </pre>
   */
  public static final class RegistryServiceForInternalStub extends io.grpc.stub.AbstractStub<RegistryServiceForInternalStub> {
    ...
    public void bistreamProxy(io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getBistreamProxyMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class RegistryServiceForInternalBlockingStub extends io.grpc.stub.AbstractStub<RegistryServiceForInternalBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.Empty sendEvents(io.holoinsight.server.common.grpc.GenericDataBatch request) {
    ...
    /**
     */
    public io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse bistreamProxy(io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest request) {
      return blockingUnaryCall(
          getChannel(), getBistreamProxyMethod(), getCallOptions(), request);
    }
  }
   ...
   * </pre>
   */
  public static final class RegistryServiceForInternalFutureStub extends io.grpc.stub.AbstractStub<RegistryServiceForInternalFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse> bistreamProxy(
      ...
      return futureUnaryCall(
          getChannel().newCall(getBistreamProxyMethod(), getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_BISTREAM_PROXY:
          serviceImpl.bistreamProxy((io.holoinsight.server.registry.grpc.internal.BiStreamProxyRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.registry.grpc.internal.BiStreamProxyResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (RegistryServiceForInternalGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getBistreamProxyMethod())
              .build();
        }
      }
    }
