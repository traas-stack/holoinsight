...
public class EsGsonUtils extends GsonUtils {
    ...
    public static Gson esGson() {
        ...
        if (gson == null) {
            gson = new GsonBuilder()
                    ...
                    .registerTypeHierarchyAdapter(SpanEsDO.class, new SpanTypeAdapter())
                    .create();
            esGs.set(gson);
        }
        return gson;
    ...
    private static class SpanTypeAdapter implements JsonSerializer<SpanEsDO>, JsonDeserializer<SpanEsDO> {
        ...
        public SpanEsDO deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            try {
                for (Field field : allFields) {
                    ...
                    if (field.isAnnotationPresent(FlatColumn.class)) {
                        ...
                        Column column = field.getAnnotation(Column.class);
                        String columnName = column.name();
                        if (Number.class.isAssignableFrom(fieldType) || fieldType == int.class || fieldType == long.class
                                || fieldType == short.class || fieldType == byte.class || fieldType == float.class
