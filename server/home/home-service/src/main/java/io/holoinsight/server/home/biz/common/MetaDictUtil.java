...
public class MetaDictUtil {
    ...
    private static <T> T convertValue(String value, final TypeToken<T> resultClass) {
        try {
            ...
            log.error("parse value: " + value + ", type: " + resultClass.getType()
    ...
    public static <T> T getValue(String type, String k, final TypeToken<T> resultClass) {
        ...
        Map<String, Map<String, MetaDataDictValue>> metaDataDictValueMap = superCacheService
                .getSc().metaDataDictValueMap;
    ...
    public static String getJiGuangHost() {
        return MetaDictUtil.getStringValue(MetaDictType.MARKETPLACE_CONFIG, MetaDictKey.MARKETPLACE_JIGUANG_HOST);
    }
    ...
    public static String getMiniProgramSlsEndPoint() {
        String accessId = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_SLS_ENDPOINT);
        if (accessId == null) {
            return "";
        }
        return accessId;
    ...
    public static String getMiniProgramSlsAccessID() {
        String accessId = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_SLS_ACCESS_ID);
        if (accessId == null) {
            return "";
        }
        return accessId;
    ...
    public static String getMiniProgramSlsAccessKey() {
        String accessKey = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_SLS_ACCESS_KEY);
        if (accessKey == null) {
            return "";
        }
        return accessKey;
    ...
    public static String getMiniProgramAntLogUrl() {
        String accessId = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_ANTLOG_URL);
        if (accessId == null) {
            return "";
        }
        return accessId;
    ...
    public static String getMiniProgramAntLogAccessID() {
        String accessId = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_ANTLOG_ACCESS_ID);
        if (accessId == null) {
            return "";
        }
        return accessId;
    ...
    public static String getMiniProgramAntLogAccessKey() {
        String accessKey = MetaDictUtil.getStringValue(MetaDictType.MNP_SLS_CONFIG, MetaDictKey.MNP_ANTLOG_ACCESS_KEY);
        if (accessKey == null) {
            return "";
        }
        return accessKey;
