...
public interface ServiceApi {
    ...
    @ApiOperation(
            value = "query service list",
            nickname = "queryServiceList",
            notes = "查询服务列表",
