...
public class QueryFacadeImpl extends BaseFacade {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                QueryProto.Datasource datasource = QueryProto.Datasource.newBuilder()
                        .setMetric(metric).setStart(System.currentTimeMillis())
                        .setEnd(System.currentTimeMillis()).build();
                QueryProto.QueryRequest.Builder builder = QueryProto.QueryRequest.newBuilder();
                if (null != ms) {
                    builder.setTenant(ms.getTenant());
                }

                QueryProto.QueryRequest request = builder
                        .addAllDatasources(Collections.singletonList(datasource)).build();
    ...
    public JsonResult<List<String>> metric(@RequestParam("name") String name) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                MonitorScope ms = RequestContext.getContext().ms;
                QueryProto.QueryMetricsRequest.Builder builder = QueryProto.QueryMetricsRequest
                        .newBuilder();
                if (null != ms) {
                    builder.setTenant(ms.getTenant());
                }
    ...
    public JsonResult<ValueResult> queryTagValues(@RequestBody TagQueryRequest tagQueryRequest) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                MonitorScope ms = RequestContext.getContext().ms;
                QueryProto.Datasource datasource = QueryProto.Datasource.newBuilder()
                        .setMetric(tagQueryRequest.getMetric())
                        .setStart(System.currentTimeMillis() - 60000 * 5)
                ...
                ValueResult response = queryClientService.queryTagValues(builder.build(),
                        tagQueryRequest.getKey());
                JsonResult.createSuccessResult(result, response);
            }
        });
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                QueryProto.PqlRangeRequest rangeRequest = QueryProto.PqlRangeRequest.newBuilder()
                        ...
                        .setTenant(RequestContext.getContext().ms.getTenant())
    ...
    public GrafanaJsonResult<List<Result>> pqlInstanceQuery(@RequestBody PqlInstanceRequest request) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                QueryProto.PqlInstantRequest instantRequest = QueryProto.PqlInstantRequest
                        .newBuilder().setQuery(request.getQuery())
                        .setTenant(RequestContext.getContext().ms.getTenant())
                        .setDelta(request.getDelta()).setTimeout(request.getTimeout())
    ...
    public JsonResult<List<Service>> queryServiceList(@RequestBody QueryProto.QueryMetaRequest request) {
    ...
    public JsonResult<List<Endpoint>> queryEndpointList(@RequestBody QueryProto.QueryMetaRequest request) {
    ...
    public JsonResult<List<ServiceInstance>> queryServiceInstanceList(@RequestBody QueryProto.QueryMetaRequest request) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                List<ServiceInstance> serviceInstances = queryClientService
    ...
    public JsonResult<List<VirtualComponent>> queryComponentList(@RequestBody QueryProto.QueryMetaRequest request) {
    ...
    public JsonResult<List<String>> queryComponentTraceIds(@RequestBody QueryProto.QueryMetaRequest request) {
    ...
    public JsonResult<Topology> queryTenantTopology(@RequestBody QueryProto.QueryTopologyRequest request) {
    ...
    public JsonResult<Boolean> createAgentConfiguration(@RequestBody AgentConfiguration agentConfiguration) {
    ...
    public JsonResult<AgentConfiguration> queryAgentConfiguration(@RequestBody AgentConfiguration agentConfiguration) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                AgentConfiguration configuration = agentConfigurationService
    ...
    public JsonResult<List<SlowSql>> querySlowSqlList(@RequestBody QueryProto.QueryMetaRequest request) {
