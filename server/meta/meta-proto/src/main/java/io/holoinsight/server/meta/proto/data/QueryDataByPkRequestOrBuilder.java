...
public interface QueryDataByPkRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:scheduler.QueryDataByPkRequest)
   ...
   */
  java.lang.String getPkVal();

  /**
   * <code>string pkVal = 2;</code>
   */
  com.google.protobuf.ByteString getPkValBytes();
