...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.Builder subBuilder = null;
            if (header_ != null) {
              subBuilder = header_.toBuilder();
            }
            header_ = input.readMessage(io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return io.holoinsight.server.gateway.grpc.GatewayProtos.internal_static_io_holoinsight_server_gateway_grpc_GetControlConfigsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.holoinsight.server.gateway.grpc.GetControlConfigsResponse.class, io.holoinsight.server.gateway.grpc.GetControlConfigsResponse.Builder.class);
  }
  ...
  public io.holoinsight.server.gateway.grpc.common.CommonResponseHeader getHeader() {
    return header_ == null ? io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.getDefaultInstance() : header_;
  }
  /**
   * <pre>
   * TODO 想一下服务端会有哪些控制参数
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    io.holoinsight.server.gateway.grpc.GetControlConfigsResponse other = (io.holoinsight.server.gateway.grpc.GetControlConfigsResponse) obj;
  ...
  public static io.holoinsight.server.gateway.grpc.GetControlConfigsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.holoinsight.server.gateway.grpc.GetControlConfigsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.holoinsight.server.gateway.grpc.GetControlConfigsResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public io.holoinsight.server.gateway.grpc.GetControlConfigsResponse buildPartial() {
      io.holoinsight.server.gateway.grpc.GetControlConfigsResponse result = new io.holoinsight.server.gateway.grpc.GetControlConfigsResponse(this);
      if (headerBuilder_ == null) {
    ...
    public Builder mergeFrom(io.holoinsight.server.gateway.grpc.GetControlConfigsResponse other) {
      if (other == io.holoinsight.server.gateway.grpc.GetControlConfigsResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (io.holoinsight.server.gateway.grpc.GetControlConfigsResponse) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.holoinsight.server.gateway.grpc.common.CommonResponseHeader, io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.Builder, io.holoinsight.server.gateway.grpc.common.CommonResponseHeaderOrBuilder> headerBuilder_;
    /**
     * <pre>
     * TODO 想一下服务端会有哪些控制参数
     * 1. 重新建连的频率, 比如默认是 30min 重新建连
     ...
     * <code>.io.holoinsight.server.gateway.grpc.common.CommonResponseHeader header = 1;</code>
     */
    public Builder mergeHeader(io.holoinsight.server.gateway.grpc.common.CommonResponseHeader value) {
      if (headerBuilder_ == null) {
        if (header_ != null) {
          header_ =
            io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.newBuilder(header_).mergeFrom(value).buildPartial();
        } else {
          header_ = value;
        }
        onChanged();
    ...
    public io.holoinsight.server.gateway.grpc.common.CommonResponseHeaderOrBuilder getHeaderOrBuilder() {
      if (headerBuilder_ != null) {
        ...
        return header_ == null ?
            io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.getDefaultInstance() : header_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.holoinsight.server.gateway.grpc.common.CommonResponseHeader, io.holoinsight.server.gateway.grpc.common.CommonResponseHeader.Builder, io.holoinsight.server.gateway.grpc.common.CommonResponseHeaderOrBuilder> 
