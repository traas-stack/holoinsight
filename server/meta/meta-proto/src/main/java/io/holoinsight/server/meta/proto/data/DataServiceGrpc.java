...
public final class DataServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getInsertOrUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "insertOrUpdate",
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getInsertOrUpdateMethod() {
        ...
        if ((getInsertOrUpdateMethod = DataServiceGrpc.getInsertOrUpdateMethod) == null) {
          DataServiceGrpc.getInsertOrUpdateMethod = getInsertOrUpdateMethod =
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getInsertMethod;
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getInsertMethod = DataServiceGrpc.getInsertMethod) == null) {
          DataServiceGrpc.getInsertMethod = getInsertMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DataBaseResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DataServiceMethodDescriptorSupplier("insert"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getUpdateMethod;
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getUpdateMethod = DataServiceGrpc.getUpdateMethod) == null) {
          DataServiceGrpc.getUpdateMethod = getUpdateMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DataBaseResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DataServiceMethodDescriptorSupplier("update"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByTableRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryDataByTableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryDataByTable",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByTableRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryDataByTableMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getQueryDataByTableMethod = DataServiceGrpc.getQueryDataByTableMethod) == null) {
          DataServiceGrpc.getQueryDataByTableMethod = getQueryDataByTableMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataByTableRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByPkRequest,
      io.holoinsight.server.meta.proto.data.QueryOneDataResponse> getQueryDataByPkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryDataByPk",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByPkRequest,
      io.holoinsight.server.meta.proto.data.QueryOneDataResponse> getQueryDataByPkMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getQueryDataByPkMethod = DataServiceGrpc.getQueryDataByPkMethod) == null) {
          DataServiceGrpc.getQueryDataByPkMethod = getQueryDataByPkMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataByPkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryOneDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByPksRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryDataByPksMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryDataByPks",
      requestType = io.holoinsight.server.meta.proto.data.QueryDataByPksRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.QueryDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByPksRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryDataByPksMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getQueryDataByPksMethod = DataServiceGrpc.getQueryDataByPksMethod) == null) {
          DataServiceGrpc.getQueryDataByPksMethod = getQueryDataByPksMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataByPksRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByTableRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryDataByTableStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByTableRequest,
    ...
    if ((getQueryDataByTableStreamMethod = DataServiceGrpc.getQueryDataByTableStreamMethod) == null) {
      synchronized (DataServiceGrpc.class) {
        if ((getQueryDataByTableStreamMethod = DataServiceGrpc.getQueryDataByTableStreamMethod) == null) {
          DataServiceGrpc.getQueryDataByTableStreamMethod = getQueryDataByTableStreamMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DataServiceMethodDescriptorSupplier("queryDataByTableStream"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getBatchDeleteByPkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "batchDeleteByPk",
      requestType = io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.DataBaseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getBatchDeleteByPkMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getBatchDeleteByPkMethod = DataServiceGrpc.getBatchDeleteByPkMethod) == null) {
          DataServiceGrpc.getBatchDeleteByPkMethod = getBatchDeleteByPkMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DataBaseResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getDeleteByExampleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteByExample",
      requestType = io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.DataBaseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getDeleteByExampleMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getDeleteByExampleMethod = DataServiceGrpc.getDeleteByExampleMethod) == null) {
          DataServiceGrpc.getDeleteByExampleMethod = getDeleteByExampleMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DataBaseResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getDeleteByRowMapMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteByRowMap",
      requestType = io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.DataBaseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getUpdateByExampleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateByExample",
      requestType = io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.DataBaseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.DataBaseResponse> getUpdateByExampleMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getUpdateByExampleMethod = DataServiceGrpc.getUpdateByExampleMethod) == null) {
          DataServiceGrpc.getUpdateByExampleMethod = getUpdateByExampleMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.DataBaseResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryByExampleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryByExample",
      requestType = io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.QueryDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryByExampleMethod() {
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getQueryByExampleMethod = DataServiceGrpc.getQueryByExampleMethod) == null) {
          DataServiceGrpc.getQueryByExampleMethod = getQueryByExampleMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getFuzzyByExampleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "fuzzyByExample",
      requestType = io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.QueryDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
      io.holoinsight.server.meta.proto.data.QueryDataResponse> getQueryByExampleStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryByExampleStream",
      requestType = io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest.class,
      responseType = io.holoinsight.server.meta.proto.data.QueryDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
      ...
      synchronized (DataServiceGrpc.class) {
        if ((getQueryByExampleStreamMethod = DataServiceGrpc.getQueryByExampleStreamMethod) == null) {
          DataServiceGrpc.getQueryByExampleStreamMethod = getQueryByExampleStreamMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.meta.proto.data.QueryDataResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DataServiceMethodDescriptorSupplier("queryByExampleStream"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DataHello,
      io.holoinsight.server.meta.proto.data.DataHello> getHeartBeatMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.meta.proto.data.DataHello,
      io.holoinsight.server.meta.proto.data.DataHello> getHeartBeatMethod() {
  ...
  public static abstract class DataServiceImplBase implements io.grpc.BindableService {
    ...
    public void insertOrUpdate(io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getInsertOrUpdateMethod(), responseObserver);
    }
    ...
    /**
     */
    public void queryDataByTable(io.holoinsight.server.meta.proto.data.QueryDataByTableRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryDataByTableMethod(), responseObserver);
    }
    ...
    public void queryDataByPk(io.holoinsight.server.meta.proto.data.QueryDataByPkRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryDataByPkMethod(), responseObserver);
    }
    ...
    public void queryDataByPks(io.holoinsight.server.meta.proto.data.QueryDataByPksRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryDataByPksMethod(), responseObserver);
    }

    /**
     */
    public void queryDataByTableStream(io.holoinsight.server.meta.proto.data.QueryDataByTableRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryDataByTableStreamMethod(), responseObserver);
    }

    /**
     */
    public void batchDeleteByPk(io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getBatchDeleteByPkMethod(), responseObserver);
    }

    /**
     */
    public void deleteByExample(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteByExampleMethod(), responseObserver);
    }

    /**
     */
    public void deleteByRowMap(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteByRowMapMethod(), responseObserver);
    }

    /**
     */
    public void updateByExample(io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateByExampleMethod(), responseObserver);
    }

    /**
     */
    public void queryByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryByExampleMethod(), responseObserver);
    }

    /**
     */
    public void fuzzyByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFuzzyByExampleMethod(), responseObserver);
    }

    /**
     */
    public void queryByExampleStream(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryByExampleStreamMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getInsertOrUpdateMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest,
                io.holoinsight.server.meta.proto.data.DataBaseResponse>(
          ...
          .addMethod(
            getQueryDataByTableMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.QueryDataByTableRequest,
                io.holoinsight.server.meta.proto.data.QueryDataResponse>(
                  this, METHODID_QUERY_DATA_BY_TABLE)))
          .addMethod(
            getQueryDataByPkMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.QueryDataByPkRequest,
                io.holoinsight.server.meta.proto.data.QueryOneDataResponse>(
                  this, METHODID_QUERY_DATA_BY_PK)))
          .addMethod(
            getQueryDataByPksMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.QueryDataByPksRequest,
                io.holoinsight.server.meta.proto.data.QueryDataResponse>(
                  this, METHODID_QUERY_DATA_BY_PKS)))
          .addMethod(
            getQueryDataByTableStreamMethod(),
          ...
          .addMethod(
            getBatchDeleteByPkMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest,
                io.holoinsight.server.meta.proto.data.DataBaseResponse>(
                  this, METHODID_BATCH_DELETE_BY_PK)))
          .addMethod(
            getDeleteByExampleMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
                io.holoinsight.server.meta.proto.data.DataBaseResponse>(
                  this, METHODID_DELETE_BY_EXAMPLE)))
          .addMethod(
            getDeleteByRowMapMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest,
                io.holoinsight.server.meta.proto.data.DataBaseResponse>(
          ...
          .addMethod(
            getUpdateByExampleMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest,
                io.holoinsight.server.meta.proto.data.DataBaseResponse>(
                  this, METHODID_UPDATE_BY_EXAMPLE)))
          .addMethod(
            getQueryByExampleMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
                io.holoinsight.server.meta.proto.data.QueryDataResponse>(
                  this, METHODID_QUERY_BY_EXAMPLE)))
          .addMethod(
            getFuzzyByExampleMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest,
                io.holoinsight.server.meta.proto.data.QueryDataResponse>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.meta.proto.data.DataHello,
                io.holoinsight.server.meta.proto.data.DataHello>(
  ...
  public static final class DataServiceStub extends io.grpc.stub.AbstractAsyncStub<DataServiceStub> {
    ...
    public void insertOrUpdate(io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getInsertOrUpdateMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryDataByTable(io.holoinsight.server.meta.proto.data.QueryDataByTableRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryDataByTableMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryDataByPk(io.holoinsight.server.meta.proto.data.QueryDataByPkRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryOneDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryDataByPkMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryDataByPks(io.holoinsight.server.meta.proto.data.QueryDataByPksRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryDataByPksMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryDataByTableStream(io.holoinsight.server.meta.proto.data.QueryDataByTableRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getQueryDataByTableStreamMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void batchDeleteByPk(io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getBatchDeleteByPkMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void deleteByExample(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteByExampleMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void deleteByRowMap(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteByRowMapMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void updateByExample(io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateByExampleMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryByExampleMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void fuzzyByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getFuzzyByExampleMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryByExampleStream(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getQueryByExampleStreamMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class DataServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DataServiceBlockingStub> {
    ...
    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse insertOrUpdate(io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getInsertOrUpdateMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse insert(io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse update(io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public io.holoinsight.server.meta.proto.data.QueryDataResponse queryDataByTable(io.holoinsight.server.meta.proto.data.QueryDataByTableRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryDataByTableMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.QueryOneDataResponse queryDataByPk(io.holoinsight.server.meta.proto.data.QueryDataByPkRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryDataByPkMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.QueryDataResponse queryDataByPks(io.holoinsight.server.meta.proto.data.QueryDataByPksRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryDataByPksMethod(), getCallOptions(), request);
    }
    ...
    public java.util.Iterator<io.holoinsight.server.meta.proto.data.QueryDataResponse> queryDataByTableStream(
      ...
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getQueryDataByTableStreamMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse batchDeleteByPk(io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getBatchDeleteByPkMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse deleteByExample(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getDeleteByExampleMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse deleteByRowMap(io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getDeleteByRowMapMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.DataBaseResponse updateByExample(io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getUpdateByExampleMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.QueryDataResponse queryByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryByExampleMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.meta.proto.data.QueryDataResponse fuzzyByExample(io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getFuzzyByExampleMethod(), getCallOptions(), request);
    }
    ...
    public java.util.Iterator<io.holoinsight.server.meta.proto.data.QueryDataResponse> queryByExampleStream(
      ...
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getQueryByExampleStreamMethod(), getCallOptions(), request);
    }
     ...
     * </pre>
     */
    public io.holoinsight.server.meta.proto.data.DataHello heartBeat(io.holoinsight.server.meta.proto.data.DataHello request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INSERT_OR_UPDATE:
          serviceImpl.insertOrUpdate((io.holoinsight.server.meta.proto.data.InsertOrUpdateRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse>) responseObserver);
          break;
        ...
        case METHODID_QUERY_DATA_BY_TABLE:
          serviceImpl.queryDataByTable((io.holoinsight.server.meta.proto.data.QueryDataByTableRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
        case METHODID_QUERY_DATA_BY_PK:
          serviceImpl.queryDataByPk((io.holoinsight.server.meta.proto.data.QueryDataByPkRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryOneDataResponse>) responseObserver);
          break;
        case METHODID_QUERY_DATA_BY_PKS:
          serviceImpl.queryDataByPks((io.holoinsight.server.meta.proto.data.QueryDataByPksRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
        case METHODID_QUERY_DATA_BY_TABLE_STREAM:
          serviceImpl.queryDataByTableStream((io.holoinsight.server.meta.proto.data.QueryDataByTableRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
        case METHODID_BATCH_DELETE_BY_PK:
          serviceImpl.batchDeleteByPk((io.holoinsight.server.meta.proto.data.BatchDeleteByPkRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse>) responseObserver);
          break;
        case METHODID_DELETE_BY_EXAMPLE:
          serviceImpl.deleteByExample((io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse>) responseObserver);
          break;
        case METHODID_DELETE_BY_ROW_MAP:
          serviceImpl.deleteByRowMap((io.holoinsight.server.meta.proto.data.DeleteDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse>) responseObserver);
          break;
        case METHODID_UPDATE_BY_EXAMPLE:
          serviceImpl.updateByExample((io.holoinsight.server.meta.proto.data.UpdateDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.DataBaseResponse>) responseObserver);
          break;
        case METHODID_QUERY_BY_EXAMPLE:
          serviceImpl.queryByExample((io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
        case METHODID_FUZZY_BY_EXAMPLE:
          serviceImpl.fuzzyByExample((io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
        case METHODID_QUERY_BY_EXAMPLE_STREAM:
          serviceImpl.queryByExampleStream((io.holoinsight.server.meta.proto.data.QueryDataByExampleRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.meta.proto.data.QueryDataResponse>) responseObserver);
          break;
      ...
      synchronized (DataServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getInsertOrUpdateMethod())
              .addMethod(getInsertMethod())
              .addMethod(getUpdateMethod())
              .addMethod(getQueryDataByTableMethod())
              .addMethod(getQueryDataByPkMethod())
              .addMethod(getQueryDataByPksMethod())
              .addMethod(getQueryDataByTableStreamMethod())
              .addMethod(getBatchDeleteByPkMethod())
              .addMethod(getDeleteByExampleMethod())
              .addMethod(getDeleteByRowMapMethod())
              .addMethod(getUpdateByExampleMethod())
              .addMethod(getQueryByExampleMethod())
              .addMethod(getFuzzyByExampleMethod())
