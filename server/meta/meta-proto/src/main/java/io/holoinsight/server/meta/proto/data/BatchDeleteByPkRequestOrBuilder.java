...
public interface BatchDeleteByPkRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:scheduler.BatchDeleteByPkRequest)
   ...
   */
  java.lang.String getPrimaryKeyValsJson();

  /**
   * <code>string primaryKeyValsJson = 2;</code>
   */
  com.google.protobuf.ByteString getPrimaryKeyValsJsonBytes();
