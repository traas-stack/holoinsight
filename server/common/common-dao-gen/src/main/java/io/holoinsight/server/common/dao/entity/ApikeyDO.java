...
public class ApikeyDO {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAccessConfig() == null ? other.getAccessConfig() == null : this.getAccessConfig().equals(other.getAccessConfig()));
    }
    ...
    public enum Column {
        ...
        apikey("apikey", "apikey", "VARCHAR", false),
        ...
        accessConfig("access_config", "accessConfig", "LONGVARCHAR", false);
