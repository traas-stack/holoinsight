...
public class DimDataWriteTask implements InitializingBean {
            ...
            Runnable threadPoolStatusTask = new Runnable() {
                ...
                public void run() {
                    L.info(String.format(
                            ...
                            executor.getTaskCount(), executor.getCompletedTaskCount(), executor.getLargestPoolSize(),
    ...
    private void sync2DB(String dimTableName, String type) {
        ...
        listList.forEach(list -> {
            ...
            agentHeartBeatService.agentInsertOrUpdate(dimTableName, MetaType.valueOf(type.toUpperCase()), list);
