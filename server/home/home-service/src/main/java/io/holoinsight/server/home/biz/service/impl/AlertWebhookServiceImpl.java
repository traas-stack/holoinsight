 ...
 */
@Service
public class AlertWebhookServiceImpl extends ServiceImpl<AlarmWebhookMapper, AlarmWebhook> implements AlertWebhookService {
    ...
    @Override
    public MonitorPageResult<AlarmWebhookDTO> getListByPage(MonitorPageRequest<AlarmWebhookDTO> pageRequest) {
        ...
        wrapper.select(AlarmWebhook.class, info -> !info.getColumn().equals("creator")
