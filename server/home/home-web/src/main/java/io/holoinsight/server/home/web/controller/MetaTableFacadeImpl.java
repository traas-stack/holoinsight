...
public class MetaTableFacadeImpl extends BaseFacade {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void doManage() {
                ...
                userOpLogService.append("meta_table", String.valueOf(save.getId()), OpType.CREATE,
                    mu.getLoginName(), RequestContext.getContext().ms.getTenant(), J.toJson(save),
                    null, null, "meta_table_update");
            }
        });
    ...
    public JsonResult<Object> update(@RequestBody MetaTableDTO metaTable) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            public void checkParameter() {
                ...
                ParaCheckUtil.checkEquals(metaTable.getTenant(),
                        RequestContext.getContext().ms.getTenant(), "tenant is illegal");

                MetaTableDTO item = metaTableService.queryById(metaTable.getId(), RequestContext.getContext().ms.getTenant());
            ...
            public void doManage() {
                ...
                userOpLogService.append("meta_table", String.valueOf(update.getId()), OpType.UPDATE,
                    mu.getLoginName(), RequestContext.getContext().ms.getTenant(),
                    J.toJson(metaTable), J.toJson(update), null, "meta_table_update");
    ...
    public JsonResult<MetaTableDTO> queryById(@PathVariable("id") Long id) {
        ...
        facadeTemplate.manage(result, new ManageCallback() {
            ...
            @Override
            public void doManage() {
                MetaTableDTO metaTable = metaTableService.queryById(id, RequestContext.getContext().ms.getTenant());
