...
public class GaeaConfigDO {
  ...
  public boolean equals(Object that) {
    ...
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        ...
        && (this.getConfKey() == null ? other.getConfKey() == null
            : this.getConfKey().equals(other.getConfKey()))
        && (this.getConfValue() == null ? other.getConfValue() == null
            : this.getConfValue().equals(other.getConfValue()));
  }
  ...
  public enum Column {
    id("id", "id", "BIGINT", false), gmtCreate("gmt_create", "gmtCreate", "TIMESTAMP",
        false), gmtModified("gmt_modified", "gmtModified", "TIMESTAMP", false), tenant("tenant",
            "tenant", "VARCHAR", false), confKey("conf_key", "confKey", "VARCHAR",
                false), confValue("conf_value", "confValue", "LONGVARCHAR", false);
