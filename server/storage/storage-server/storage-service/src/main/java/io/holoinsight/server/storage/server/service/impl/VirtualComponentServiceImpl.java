...
public class VirtualComponentServiceImpl implements VirtualComponentService {
    ...
    @Override
    public List<VirtualComponent> getDbList(String tenant, String service, long startTime, long endTime) throws IOException {
        List<VirtualComponent> dbList = virtualComponentEsService.getComponentList(tenant, service, startTime, endTime, RequestType.DATABASE, Const.SOURCE);
        dbList.forEach(db -> {
    ...
    @Override
    public List<VirtualComponent> getCacheList(String tenant, String service, long startTime, long endTime) throws IOException {
        List<VirtualComponent> cacheList = virtualComponentEsService.getComponentList(tenant, service, startTime, endTime, RequestType.CACHE, Const.SOURCE);
    ...
    @Override
    public List<VirtualComponent> getMQList(String tenant, String service, long startTime, long endTime) throws IOException {
        List<VirtualComponent> mqList = new ArrayList<>();
        mqList.addAll(virtualComponentEsService.getComponentList(tenant, service, startTime, endTime, RequestType.MQ, Const.SOURCE));
        mqList.addAll(virtualComponentEsService.getComponentList(tenant, service, startTime, endTime, RequestType.MQ, Const.DEST));
        mqList.forEach(mq -> {
