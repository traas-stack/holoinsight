...
public class AddressUtil {
    ...
    public static String getLocalHostName() {
        if (StringUtils.isNotBlank(localHostName)) { return localHostName; }
        if (StringUtils.isBlank(localHostName) && StringUtils.isNotBlank(localHostIPV4)) { return localHostIPV4; }
        if (StringUtils.isBlank(localHostName) && StringUtils.isNotBlank(localHostIPV6)) { return localHostIPV6; }
        return "-";
    }
