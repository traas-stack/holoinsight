...
public class SystemMetricCrawlerBuilder extends AbstractMetricCrawlerBuilder {
  ...
  protected List<MetricInfo> getMetricInfoList(String metric, List<String> tags) {
    ...
    metricInfoList
        .add(genMetricInfo(GLOBAL_TENANT, GLOBAL_WORKSPACE, GLOBAL_ORGANIZATION, "k8s", "TRAFFIC",
    ...
    metricInfoList
        .add(genMetricInfo(GLOBAL_TENANT, GLOBAL_WORKSPACE, GLOBAL_ORGANIZATION, "k8s", "TCP",
    ...
    metricInfoList
        .add(genMetricInfo(GLOBAL_TENANT, GLOBAL_WORKSPACE, GLOBAL_ORGANIZATION, "k8s", "CPU",
