...
public interface TopologyApi {
    ...
    @ApiOperation(
            value = "query tenant topology",
            nickname = "queryTenantTopology",
            notes = "查询租户下的拓扑",
            response = Topology.class,
            authorizations = {
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(code = 200, message = "请求正常。", response = Topology.class),
                    @ApiResponse(code = 400, message = "请求失败。", response = FailResponse.class)
            })
    @RequestMapping(
            value = "/query/tenantTopology",
            produces = {"application/json"},
            consumes = {"application/json"},
            method = RequestMethod.POST)
    ResponseEntity<Topology> queryTenantTopology(
            @ApiParam(value = "查询条件。", required = true) @Valid @RequestBody
            QueryTopologyRequest request) throws IOException;


    @ApiOperation(
            value = "query service topology",
            nickname = "queryServiceTopology",
            notes = "查询服务的拓扑",
            response = Topology.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
    ...
    @ApiOperation(
            value = "query serviceInstance topology",
            nickname = "queryServiceInstanceTopology",
            notes = "查询服务实例的拓扑",
            response = Topology.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
    ...
    @RequestMapping(
            value = "/query/serviceInstanceTopology",
            produces = {"application/json"},
            consumes = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(
            value = "query endpoint topology",
            nickname = "queryEndpointTopology",
            notes = "查询接口的拓扑",
            response = Topology.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
    ...
    @ApiOperation(
            value = "query db topology",
            nickname = "queryDbTopology",
            notes = "查询数据库的拓扑",
            response = Topology.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
    ...
    @ApiOperation(
            value = "query mq topology",
            nickname = "queryMQTopology",
            notes = "查询消息队列的拓扑",
            response = Topology.class,
            authorizations = {
                    @Authorization(value = "APIKeyHeader"),
