 ...
 */
@Service
public class AnomalyDownAbnormalDetect implements FunctionLogic {
  private static final Logger LOGGER = LoggerFactory.getLogger(AnomalyDownAbnormalDetect.class);
  ...
  public FunctionEnum getFunc() {
    return FunctionEnum.AnomalyDown;
  }
  ...
  public TriggerResult invoke(DataResult dataResult, FunctionConfigParam functionConfigParam) {
    ...
    algorithmConfig.setAlgorithmType("down");
