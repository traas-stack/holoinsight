...
public class DateUtil {
    ...
    public static Date setHoursToEmpty(Date date) {
        Calendar calendar = Calendar.getInstance();
        int timeTypes[] = {Calendar.HOUR_OF_DAY, Calendar.MINUTE, Calendar.SECOND, Calendar.MILLISECOND};
        calendar.setTime(date);
    ...
    public static List<Date> getDays(Date start, Date end) {
        ...
        Calendar calendar = Calendar.getInstance();
        int timeTypes[] = {Calendar.MILLISECOND, Calendar.SECOND, Calendar.MINUTE, Calendar.HOUR_OF_DAY};
