...
public interface WriteMetricsRequestV3OrBuilder extends
   ...
   */
  java.util.List<io.holoinsight.server.gateway.grpc.WriteMetricsRequestV3.TaskBatch> 
      getBatchList();
  /**
   * <code>repeated .io.holoinsight.server.gateway.grpc.WriteMetricsRequestV3.TaskBatch batch = 2;</code>
   */
   ...
   * <code>repeated .io.holoinsight.server.gateway.grpc.WriteMetricsRequestV3.TaskBatch batch = 2;</code>
   */
  java.util.List<? extends io.holoinsight.server.gateway.grpc.WriteMetricsRequestV3.TaskBatchOrBuilder> 
