...
public class GaeaLockDO {
  ...
  public boolean equals(Object that) {
    ...
    GaeaLockDO other = (GaeaLockDO) that;
  ...
  public static GaeaLockDO.Builder builder() {
    return new GaeaLockDO.Builder();
  }

  public static class Builder {
    private GaeaLockDO obj;

    public Builder() {
      this.obj = new GaeaLockDO();
    }
  ...
  public enum Column {
    id("id", "id", "BIGINT", false), gmtCreate("gmt_create", "gmtCreate", "TIMESTAMP",
        false), gmtModified("gmt_modified", "gmtModified", "TIMESTAMP", false), tenant("tenant",
            "tenant", "VARCHAR", false), name("name", "name", "VARCHAR", true), version("version",
                "version", "INTEGER", false), json("json", "json", "VARCHAR",
                    false), status("status", "status", "INTEGER", true);
