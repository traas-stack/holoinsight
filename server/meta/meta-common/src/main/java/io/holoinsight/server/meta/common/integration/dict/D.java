...
public final class D {
    ...
    public static String getDict(String dictKey) {
        return Dictionaries.getInstance().getDict(ConstPool.COMMON_DICT_DOMAIN, ConstPool.COMMON_DICT_DOMAIN, dictKey);
    }

    public static String getDict(String dictKey, String defaultValue) {
        String dict = Dictionaries.getInstance().getDict(ConstPool.COMMON_DICT_DOMAIN, ConstPool.COMMON_DICT_DOMAIN,
                dictKey);
        return dict == null ? defaultValue : dict;
    }

    public static int getInt(String dictKey, int defaultValue) {
        return getInt(ConstPool.COMMON_DICT_DOMAIN, ConstPool.COMMON_DICT_DOMAIN, dictKey, defaultValue);
    }
    ...
    public static int getInt(String domain, String subDomain, String dictKey, int defaultValue) {
        ...
        try {
            ...
            log.error("can not cast dict value[{},{},{},{}] to integer,use default value[{}].", domain, subDomain,
                    dictKey, num, defaultValue);
            return defaultValue;
        }
    }
}