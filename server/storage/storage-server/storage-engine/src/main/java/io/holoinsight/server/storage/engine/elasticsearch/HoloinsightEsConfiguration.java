...
import io.holoinsight.server.storage.engine.elasticsearch.installer.ColumnTypeEsMapping;
import io.holoinsight.server.storage.engine.elasticsearch.installer.EsModelInstaller;
import io.holoinsight.server.storage.engine.elasticsearch.storage.impl.*;
