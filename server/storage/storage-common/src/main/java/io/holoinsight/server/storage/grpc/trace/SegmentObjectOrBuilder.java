...
public interface SegmentObjectOrBuilder extends
    // @@protoc_insertion_point(interface_extends:io.holoinsight.server.storage.grpc.trace.SegmentObject)
   ...
   */
  java.util.List<io.holoinsight.server.storage.grpc.trace.SpanObject> getSpansList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SpanObject spans = 3;</code>
   */
  io.holoinsight.server.storage.grpc.trace.SpanObject getSpans(int index);
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SpanObject spans = 3;</code>
   */
  java.util.List<? extends io.holoinsight.server.storage.grpc.trace.SpanObjectOrBuilder> getSpansOrBuilderList();
   ...
   * <code>repeated .io.holoinsight.server.storage.grpc.trace.SpanObject spans = 3;</code>
   */
  io.holoinsight.server.storage.grpc.trace.SpanObjectOrBuilder getSpansOrBuilder(int index);
