...
public interface AgentConfigurationDOMapper {
  ...
  int deleteByPrimaryKey(@Param("tenant") String tenant, @Param("service") String service,
      @Param("appId") String appId, @Param("envId") String envId);

  int insert(AgentConfigurationDO record);

  int insertSelective(@Param("record") AgentConfigurationDO record,
      @Param("selective") AgentConfigurationDO.Column... selective);

  AgentConfigurationDO selectOneByExample(AgentConfigurationDOExample example);

  AgentConfigurationDO selectOneByExampleSelective(
      @Param("example") AgentConfigurationDOExample example,
      @Param("selective") AgentConfigurationDO.Column... selective);

  AgentConfigurationDO selectOneByExampleWithBLOBs(AgentConfigurationDOExample example);

  List<AgentConfigurationDO> selectByExampleSelective(
      @Param("example") AgentConfigurationDOExample example,
      @Param("selective") AgentConfigurationDO.Column... selective);
  ...
  AgentConfigurationDO selectByPrimaryKeySelective(@Param("tenant") String tenant,
      @Param("service") String service, @Param("appId") String appId, @Param("envId") String envId,
      @Param("selective") AgentConfigurationDO.Column... selective);

  AgentConfigurationDO selectByPrimaryKey(@Param("tenant") String tenant,
      @Param("service") String service, @Param("appId") String appId, @Param("envId") String envId);

  int updateByExampleSelective(@Param("record") AgentConfigurationDO record,
      @Param("example") AgentConfigurationDOExample example,
      @Param("selective") AgentConfigurationDO.Column... selective);

  int updateByExampleWithBLOBs(@Param("record") AgentConfigurationDO record,
      @Param("example") AgentConfigurationDOExample example);

  int updateByExample(@Param("record") AgentConfigurationDO record,
      @Param("example") AgentConfigurationDOExample example);

  int updateByPrimaryKeySelective(@Param("record") AgentConfigurationDO record,
      @Param("selective") AgentConfigurationDO.Column... selective);
  ...
  int batchInsertSelective(@Param("list") List<AgentConfigurationDO> list,
      @Param("selective") AgentConfigurationDO.Column... selective);
