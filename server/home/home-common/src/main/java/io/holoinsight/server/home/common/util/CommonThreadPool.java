...
public class CommonThreadPool {
    public static ThreadPoolTaskExecutor createThreadPool(int coreSize, int maxSize, int queueCapacity, String tpname) {
    ...
    public static TaskScheduler newFixedThreadPoolTaskScheduler(int size, int awaitTerminationSeconds, final String poolName) {
