...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getQueryDataMethod;
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getQueryDataMethod() {
        ...
        if ((getQueryDataMethod = QueryServiceGrpc.getQueryDataMethod) == null) {
          QueryServiceGrpc.getQueryDataMethod = getQueryDataMethod =
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getQueryTagsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryTags",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryRequest.class,
      responseType = io.holoinsight.server.query.grpc.QueryProto.QueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
      io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse> getQuerySchemaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QuerySchema",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryRequest.class,
        ...
        if ((getQuerySchemaMethod = QueryServiceGrpc.getQuerySchemaMethod) == null) {
          QueryServiceGrpc.getQuerySchemaMethod = getQuerySchemaMethod =
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse> getQueryMetricsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse> getQueryMetricsMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryMetricsMethod = QueryServiceGrpc.getQueryMetricsMethod) == null) {
          QueryServiceGrpc.getQueryMetricsMethod = getQueryMetricsMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getDeleteKeysMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getPqlInstantQueryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "pqlInstantQuery",
      requestType = io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest.class,
      responseType = io.holoinsight.server.query.grpc.QueryProto.QueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getPqlInstantQueryMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getPqlInstantQueryMethod = QueryServiceGrpc.getPqlInstantQueryMethod) == null) {
          QueryServiceGrpc.getPqlInstantQueryMethod = getPqlInstantQueryMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getPqlRangeQueryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "pqlRangeQuery",
      requestType = io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest.class,
      responseType = io.holoinsight.server.query.grpc.QueryProto.QueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryResponse> getPqlRangeQueryMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getPqlRangeQueryMethod = QueryServiceGrpc.getPqlRangeQueryMethod) == null) {
          QueryServiceGrpc.getPqlRangeQueryMethod = getPqlRangeQueryMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
      io.holoinsight.server.query.grpc.QueryProto.TraceBrief> getQueryBasicTracesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryBasicTraces",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
      io.holoinsight.server.query.grpc.QueryProto.TraceBrief> getQueryBasicTracesMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryBasicTracesMethod = QueryServiceGrpc.getQueryBasicTracesMethod) == null) {
          QueryServiceGrpc.getQueryBasicTracesMethod = getQueryBasicTracesMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
      io.holoinsight.server.query.grpc.QueryProto.Trace> getQueryTraceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryTrace",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest.class,
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
      io.holoinsight.server.query.grpc.QueryProto.StatisticData> getBillingTraceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "BillingTrace",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest.class,
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> getQueryServiceListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryServiceList",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> getQueryServiceListMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryServiceListMethod = QueryServiceGrpc.getQueryServiceListMethod) == null) {
          QueryServiceGrpc.getQueryServiceListMethod = getQueryServiceListMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> getQueryEndpointListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryEndpointList",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.class,
      responseType = io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryEndpointListMethod = QueryServiceGrpc.getQueryEndpointListMethod) == null) {
          QueryServiceGrpc.getQueryEndpointListMethod = getQueryEndpointListMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse.getDefaultInstance()))
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryEndpointList"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> getQueryServiceInstanceListMethod;
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
    ...
    if ((getQueryServiceInstanceListMethod = QueryServiceGrpc.getQueryServiceInstanceListMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryServiceInstanceListMethod = QueryServiceGrpc.getQueryServiceInstanceListMethod) == null) {
          QueryServiceGrpc.getQueryServiceInstanceListMethod = getQueryServiceInstanceListMethod =
              io.grpc.MethodDescriptor.<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest, io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryServiceInstanceList"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse.getDefaultInstance()))
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryServiceInstanceList"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse> getQueryComponentListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryComponentList",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.class,
        ...
        if ((getQueryComponentListMethod = QueryServiceGrpc.getQueryComponentListMethod) == null) {
          QueryServiceGrpc.getQueryComponentListMethod = getQueryComponentListMethod =
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse.getDefaultInstance()))
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryComponentList"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.TraceIds> getQueryComponentTraceIdsMethod;
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
    ...
    if ((getQueryComponentTraceIdsMethod = QueryServiceGrpc.getQueryComponentTraceIdsMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryComponentTraceIdsMethod = QueryServiceGrpc.getQueryComponentTraceIdsMethod) == null) {
          QueryServiceGrpc.getQueryComponentTraceIdsMethod = getQueryComponentTraceIdsMethod =
              ...
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryComponentTraceIds"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest,
      io.holoinsight.server.query.grpc.QueryProto.Topology> getQueryTopologyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryTopology",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest,
      io.holoinsight.server.query.grpc.QueryProto.Topology> getQueryTopologyMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryTopologyMethod = QueryServiceGrpc.getQueryTopologyMethod) == null) {
          QueryServiceGrpc.getQueryTopologyMethod = getQueryTopologyMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse> getQuerySlowSqlListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QuerySlowSqlList",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.class,
        ...
        if ((getQuerySlowSqlListMethod = QueryServiceGrpc.getQuerySlowSqlListMethod) == null) {
          QueryServiceGrpc.getQuerySlowSqlListMethod = getQuerySlowSqlListMethod =
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.StatisticRequest,
      io.holoinsight.server.query.grpc.QueryProto.StatisticDataList> getStatisticTraceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StatisticTrace",
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.StatisticRequest,
      io.holoinsight.server.query.grpc.QueryProto.StatisticDataList> getStatisticTraceMethod() {
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getStatisticTraceMethod = QueryServiceGrpc.getStatisticTraceMethod) == null) {
          QueryServiceGrpc.getStatisticTraceMethod = getStatisticTraceMethod =
              ...
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.StatisticRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.StatisticDataList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryServiceErrorList",
      requestType = io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.class,
      responseType = io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorListMethod() {
    io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest, io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorListMethod;
    if ((getQueryServiceErrorListMethod = QueryServiceGrpc.getQueryServiceErrorListMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryServiceErrorListMethod = QueryServiceGrpc.getQueryServiceErrorListMethod) == null) {
          QueryServiceGrpc.getQueryServiceErrorListMethod = getQueryServiceErrorListMethod =
              io.grpc.MethodDescriptor.<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest, io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryServiceErrorList"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorDetailMethod;
  ...
  public static io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
      io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorDetailMethod() {
    io.grpc.MethodDescriptor<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest, io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> getQueryServiceErrorDetailMethod;
    if ((getQueryServiceErrorDetailMethod = QueryServiceGrpc.getQueryServiceErrorDetailMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryServiceErrorDetailMethod = QueryServiceGrpc.getQueryServiceErrorDetailMethod) == null) {
          QueryServiceGrpc.getQueryServiceErrorDetailMethod = getQueryServiceErrorDetailMethod =
              io.grpc.MethodDescriptor.<io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest, io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryServiceErrorDetail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData.getDefaultInstance()))
              .setSchemaDescriptor(new QueryServiceMethodDescriptorSupplier("QueryServiceErrorDetail"))
              .build();
        }
      }
    }
  ...
  public static abstract class QueryServiceImplBase implements io.grpc.BindableService {
    ...
    public void querySchema(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQuerySchemaMethod(), responseObserver);
    }

    /**
     */
    public void queryMetrics(io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest request,
    ...
    /**
     */
    public void pqlInstantQuery(io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPqlInstantQueryMethod(), responseObserver);
    }
    ...
    public void pqlRangeQuery(io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPqlRangeQueryMethod(), responseObserver);
    }

    /**
     */
    public void queryBasicTraces(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceBrief> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryBasicTracesMethod(), responseObserver);
    }
    ...
    public void billingTrace(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getBillingTraceMethod(), responseObserver);
    }

    /**
     */
    public void queryServiceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryServiceListMethod(), responseObserver);
    }

    /**
     */
    public void queryEndpointList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryEndpointListMethod(), responseObserver);
    }

    /**
     */
    public void queryServiceInstanceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryServiceInstanceListMethod(), responseObserver);
    }

    /**
     */
    public void queryComponentList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryComponentListMethod(), responseObserver);
    }

    /**
     */
    public void queryComponentTraceIds(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceIds> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryComponentTraceIdsMethod(), responseObserver);
    }

    /**
     */
    public void queryTopology(io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.Topology> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryTopologyMethod(), responseObserver);
    }

    /**
     */
    public void querySlowSqlList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQuerySlowSqlListMethod(), responseObserver);
    }
    ...
    public void statisticTrace(io.holoinsight.server.query.grpc.QueryProto.StatisticRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStatisticTraceMethod(), responseObserver);
    }

    /**
     */
    public void queryServiceErrorList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryServiceErrorListMethod(), responseObserver);
    }

    /**
     */
    public void queryServiceErrorDetail(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryServiceErrorDetailMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryResponse>(
          ...
          .addMethod(
            getQuerySchemaMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryRequest,
                io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse>(
                  this, METHODID_QUERY_SCHEMA)))
          .addMethod(
            getQueryMetricsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse>(
          ...
          .addMethod(
            getPqlInstantQueryMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryResponse>(
                  this, METHODID_PQL_INSTANT_QUERY)))
          .addMethod(
            getPqlRangeQueryMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryResponse>(
                  this, METHODID_PQL_RANGE_QUERY)))
          .addMethod(
            getQueryBasicTracesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
                io.holoinsight.server.query.grpc.QueryProto.TraceBrief>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
                io.holoinsight.server.query.grpc.QueryProto.Trace>(
                  this, METHODID_QUERY_TRACE)))
          .addMethod(
            getBillingTraceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest,
                io.holoinsight.server.query.grpc.QueryProto.StatisticData>(
                  this, METHODID_BILLING_TRACE)))
          .addMethod(
            getQueryServiceListMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>(
                  this, METHODID_QUERY_SERVICE_LIST)))
          .addMethod(
            getQueryEndpointListMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>(
          ...
          .addMethod(
            getQueryServiceInstanceListMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>(
          ...
          .addMethod(
            getQueryComponentTraceIdsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.TraceIds>(
                  this, METHODID_QUERY_COMPONENT_TRACE_IDS)))
          .addMethod(
            getQueryTopologyMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest,
                io.holoinsight.server.query.grpc.QueryProto.Topology>(
                  this, METHODID_QUERY_TOPOLOGY)))
          .addMethod(
            getQuerySlowSqlListMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse>(
                  this, METHODID_QUERY_SLOW_SQL_LIST)))
          .addMethod(
            getStatisticTraceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.StatisticRequest,
                io.holoinsight.server.query.grpc.QueryProto.StatisticDataList>(
                  this, METHODID_STATISTIC_TRACE)))
          .addMethod(
            getQueryServiceErrorListMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>(
                  this, METHODID_QUERY_SERVICE_ERROR_LIST)))
          .addMethod(
            getQueryServiceErrorDetailMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest,
                io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>(
  ...
  public static final class QueryServiceStub extends io.grpc.stub.AbstractAsyncStub<QueryServiceStub> {
    ...
    public void querySchema(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQuerySchemaMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void pqlInstantQuery(io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPqlInstantQueryMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void pqlRangeQuery(io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPqlRangeQueryMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryBasicTraces(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceBrief> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryBasicTracesMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void billingTrace(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.StatisticData> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getBillingTraceMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryServiceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryServiceListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryEndpointList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryEndpointListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryServiceInstanceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryServiceInstanceListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryComponentList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryComponentListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryComponentTraceIds(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceIds> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryComponentTraceIdsMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryTopology(io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.Topology> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryTopologyMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void querySlowSqlList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQuerySlowSqlListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void statisticTrace(io.holoinsight.server.query.grpc.QueryProto.StatisticRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.StatisticDataList> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getStatisticTraceMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryServiceErrorList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryServiceErrorListMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void queryServiceErrorDetail(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request,
        io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryServiceErrorDetailMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class QueryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<QueryServiceBlockingStub> {
    ...
    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryResponse queryData(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request) {
    ...
    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryResponse queryTags(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryTagsMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse querySchema(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQuerySchemaMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse queryMetrics(io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryResponse deleteKeys(io.holoinsight.server.query.grpc.QueryProto.QueryRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryResponse pqlInstantQuery(io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getPqlInstantQueryMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryResponse pqlRangeQuery(io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getPqlRangeQueryMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.TraceBrief queryBasicTraces(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryBasicTracesMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.Trace queryTrace(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryTraceMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.StatisticData billingTrace(io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getBillingTraceMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse queryServiceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryServiceListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse queryEndpointList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryEndpointListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse queryServiceInstanceList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryServiceInstanceListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse queryComponentList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryComponentListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.TraceIds queryComponentTraceIds(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryComponentTraceIdsMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.Topology queryTopology(io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryTopologyMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse querySlowSqlList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQuerySlowSqlListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.StatisticDataList statisticTrace(io.holoinsight.server.query.grpc.QueryProto.StatisticRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getStatisticTraceMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData queryServiceErrorList(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryServiceErrorListMethod(), getCallOptions(), request);
    }

    /**
     */
    public io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData queryServiceErrorDetail(io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getQueryServiceErrorDetailMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class QueryServiceFutureStub extends io.grpc.stub.AbstractFutureStub<QueryServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<io.holoinsight.server.query.grpc.QueryProto.QueryResponse> queryTags(
        io.holoinsight.server.query.grpc.QueryProto.QueryRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getQueryTagsMethod(), getCallOptions()), request);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<io.holoinsight.server.query.grpc.QueryProto.Trace> queryTrace(
        io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getQueryTraceMethod(), getCallOptions()), request);
    }
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> queryServiceErrorList(
        io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData> queryServiceErrorDetail(
        io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_STATISTIC_TRACE = 17;
  private static final int METHODID_QUERY_SERVICE_ERROR_LIST = 18;
  private static final int METHODID_QUERY_SERVICE_ERROR_DETAIL = 19;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_QUERY_SCHEMA:
          serviceImpl.querySchema((io.holoinsight.server.query.grpc.QueryProto.QueryRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QuerySchemaResponse>) responseObserver);
          break;
        case METHODID_QUERY_METRICS:
          serviceImpl.queryMetrics((io.holoinsight.server.query.grpc.QueryProto.QueryMetricsRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetricsResponse>) responseObserver);
          break;
        ...
        case METHODID_PQL_INSTANT_QUERY:
          serviceImpl.pqlInstantQuery((io.holoinsight.server.query.grpc.QueryProto.PqlInstantRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse>) responseObserver);
          break;
        case METHODID_PQL_RANGE_QUERY:
          serviceImpl.pqlRangeQuery((io.holoinsight.server.query.grpc.QueryProto.PqlRangeRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryResponse>) responseObserver);
          break;
        case METHODID_QUERY_BASIC_TRACES:
          serviceImpl.queryBasicTraces((io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceBrief>) responseObserver);
          break;
        case METHODID_QUERY_TRACE:
          serviceImpl.queryTrace((io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.Trace>) responseObserver);
          break;
        case METHODID_BILLING_TRACE:
          serviceImpl.billingTrace((io.holoinsight.server.query.grpc.QueryProto.QueryTraceRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.StatisticData>) responseObserver);
          break;
        case METHODID_QUERY_SERVICE_LIST:
          serviceImpl.queryServiceList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>) responseObserver);
          break;
        case METHODID_QUERY_ENDPOINT_LIST:
          serviceImpl.queryEndpointList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>) responseObserver);
          break;
        case METHODID_QUERY_SERVICE_INSTANCE_LIST:
          serviceImpl.queryServiceInstanceList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryMetaResponse>) responseObserver);
          break;
        case METHODID_QUERY_COMPONENT_LIST:
          serviceImpl.queryComponentList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QueryVirtualComponentResponse>) responseObserver);
          break;
        case METHODID_QUERY_COMPONENT_TRACE_IDS:
          serviceImpl.queryComponentTraceIds((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.TraceIds>) responseObserver);
          break;
        case METHODID_QUERY_TOPOLOGY:
          serviceImpl.queryTopology((io.holoinsight.server.query.grpc.QueryProto.QueryTopologyRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.Topology>) responseObserver);
          break;
        case METHODID_QUERY_SLOW_SQL_LIST:
          serviceImpl.querySlowSqlList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.QuerySlowSqlResponse>) responseObserver);
          break;
        case METHODID_STATISTIC_TRACE:
          serviceImpl.statisticTrace((io.holoinsight.server.query.grpc.QueryProto.StatisticRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.StatisticDataList>) responseObserver);
          break;
        case METHODID_QUERY_SERVICE_ERROR_LIST:
          serviceImpl.queryServiceErrorList((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>) responseObserver);
          break;
        case METHODID_QUERY_SERVICE_ERROR_DETAIL:
          serviceImpl.queryServiceErrorDetail((io.holoinsight.server.query.grpc.QueryProto.QueryMetaRequest) request,
              (io.grpc.stub.StreamObserver<io.holoinsight.server.query.grpc.QueryProto.CommonMapTypeData>) responseObserver);
          break;
        default:
      ...
      synchronized (QueryServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getQueryTagsMethod())
              .addMethod(getQuerySchemaMethod())
              .addMethod(getQueryMetricsMethod())
              .addMethod(getDeleteKeysMethod())
              .addMethod(getPqlInstantQueryMethod())
              .addMethod(getPqlRangeQueryMethod())
              .addMethod(getQueryBasicTracesMethod())
              .addMethod(getQueryTraceMethod())
              .addMethod(getBillingTraceMethod())
              .addMethod(getQueryServiceListMethod())
              .addMethod(getQueryEndpointListMethod())
              .addMethod(getQueryServiceInstanceListMethod())
              .addMethod(getQueryComponentListMethod())
              .addMethod(getQueryComponentTraceIdsMethod())
              .addMethod(getQueryTopologyMethod())
              .addMethod(getQuerySlowSqlListMethod())
              .addMethod(getStatisticTraceMethod())
              .addMethod(getQueryServiceErrorListMethod())
              .addMethod(getQueryServiceErrorDetailMethod())
              .build();
        }
      }
    }
