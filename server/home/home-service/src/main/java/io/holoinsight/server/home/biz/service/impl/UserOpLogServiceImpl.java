...
public class UserOpLogServiceImpl extends ServiceImpl<UserOpLogMapper, UserOpLog>
    ...
    public MonitorPageResult<UserOpLog> getListByPage(MonitorTimePageRequest<UserOpLog> userOpLogRequest) {
        ...
        Page<UserOpLog> page = new Page<>(userOpLogRequest.getPageNum(),
            userOpLogRequest.getPageSize());
    ...
    public UserOpLog append(String tableName, String tableEntityId, String opType, String user,
                            String tenant, String before, String after, String relate,
                            String name) {
