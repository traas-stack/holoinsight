...
public class CommonThreadPools {
    ...
    /**
     * <p>Constructor for CommonThreadPools.</p>
     */
    ...
    /**
     * <p>Getter for the field <code>dynamicScheduler</code>.</p>
     */
    ...
    /**
     * <p>Getter for the field <code>rpcServer</code>.</p>
     */
    ...
    /**
     * <p>Getter for the field <code>rpcClient</code>.</p>
     */
    ...
    /**
     * <p>Getter for the field <code>io</code>.</p>
     */
    ...
    private static ExecutorService executor(int min, int max, int keepalive, int queue, String nameFormat) {
        ThreadFactory tf = new ThreadFactoryBuilder() //
            .setNameFormat(nameFormat) //
            .setUncaughtExceptionHandler(HANDLER) //
            .build(); //
        ThreadPoolExecutor tpe = new ThreadPoolExecutor(min, max, keepalive, TimeUnit.SECONDS, new ArrayBlockingQueue<>(queue), tf,
