...
public final class MetricsUtils {
    ...
    public static final StatManager SM = new StatManager(TimeUnit.MINUTES.toMillis(1), STAT::info, false);
    public static final StatManager SM1S = new StatManager(TimeUnit.SECONDS.toMillis(1), STAT1S::info, false);
