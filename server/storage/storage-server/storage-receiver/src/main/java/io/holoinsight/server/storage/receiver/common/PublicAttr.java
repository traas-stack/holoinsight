...
public class PublicAttr {
    ...
    public static void setPublicAttrs(RelationBuilder sourceBuilder, Span span, Map<String, AnyValue> spanAttrMap, Map<String, AnyValue> resourceAttrMap) {
        ...
        sourceBuilder.setTimeBucket(TimeBucket.getRecordTimeBucket(TimeUtils.unixNano2MS(span.getStartTimeUnixNano())));
