...
public class Step4AccessLogFilter implements Filter {
    ...
    public void doFilter(
        ...
        CountServletResponseWrapper responseWrapper =
                new CountServletResponseWrapper(resp);
        try {
            filterChain.doFilter(req, responseWrapper);
        } catch (Exception e) {
            JsonResult<Object> result = new JsonResult<>();
            JsonResult.createFailResult(result, String.valueOf(HttpStatus.BAD_REQUEST.value()), e.getMessage());
